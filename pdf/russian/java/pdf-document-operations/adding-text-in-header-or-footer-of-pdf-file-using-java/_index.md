...
В этом руководстве мы узнали, как добавлять текст в верхний или нижний колонтитул файла PDF с помощью Java и Aspose.PDF для Java. Эта возможность позволяет вам настраивать ваши документы PDF, чтобы включать важную информацию в верхние и нижние колонтитулы по мере необходимости.
