...
Да, вы можете настроить внешний вид документа PDF с помощью Aspose.PDF for Java. Вы можете задать размер страницы, поля, шрифты, цвета и многое другое для создания файлов PDF, которые соответствуют вашему желаемому стилю.
