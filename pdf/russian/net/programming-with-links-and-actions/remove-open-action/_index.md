...
Теперь, когда вы все настроили и готовы, давайте перейдем к деталям удаления открытых действий из документа PDF.
...
Этот шаг не является строго обязательным, но приятно иметь закрытие после выполнения операций. Вы сделали это! Вы успешно удалили действие открытия из документа PDF.
