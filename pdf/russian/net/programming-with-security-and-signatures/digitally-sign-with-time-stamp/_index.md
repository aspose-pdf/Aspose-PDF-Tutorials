...
- «Контакты»: введите контактную информацию подписавшего.
...
Да, но в руководстве основное внимание уделяется использованию файла PFX, который является наиболее распространенным форматом для цифровых сертификатов.

### Нужно ли мне подключение к Интернету для применения временной метки?  
Да, поскольку временная метка извлекается из онлайн-службы временных меток, вам потребуется доступ к Интернету.
