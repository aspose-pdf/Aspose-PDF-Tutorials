...
Теперь мы пройдемся по всем полям в PDF-документе, уделяя особое внимание полям подписи (поскольку изображения обычно встроены именно сюда).
...
- Наконец, мы преобразуем поток в битмап и сохраняем его как файл JPEG.
