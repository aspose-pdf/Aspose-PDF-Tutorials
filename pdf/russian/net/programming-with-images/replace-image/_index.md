...
4. Образец PDF-файла и изображения: для тестирования вам понадобится образец PDF-файла (*ЗаменитьИзображение.pdf*) и файл изображения (например *aspose-logo.jpg*), которые вы хотите вставить. Их следует поместить в удобный каталог.
