...
Мы хотим классифицировать изображения по их цветовому типу (оттенки серого или RGB). Для этого мы настроим счетчики для каждого типа изображения, прежде чем погрузиться в страницы.
...
### Могу ли я использовать Aspose.PDF для извлечения изображений и преобразования их в другой формат?  
