...
| [Уменьшить изображения в PDF-файле](./shrink-images/) | Легко сжимайте изображения в файлах PDF с помощью Aspose.PDF для .NET с этим пошаговым руководством, обеспечивая меньшие размеры файлов при сохранении качества. |  
