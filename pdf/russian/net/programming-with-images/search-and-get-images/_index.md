...
Для беспрепятственного написания и запуска кода следует настроить подходящую среду разработки, например Visual Studio или любую другую IDE по вашему выбору.
