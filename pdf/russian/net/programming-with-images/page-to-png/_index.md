...
Теперь давайте создадим объект FileStream, где будет сохранено наше изображение PNG. Это похоже на подготовку чистого холста, на котором мы можем рисовать.
