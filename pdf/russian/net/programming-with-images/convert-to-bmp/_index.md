...
3. IDE – Visual Studio или любая другая среда разработки C#, с которой вам удобно работать.
...
5. Временная или полная лицензия — чтобы снять ограничения на оценку, получите [временная лицензия](https://purchase.aspose.com/tempилиary-license/) or [купить](https://purchase.aspose.com/buy) полная версия.
