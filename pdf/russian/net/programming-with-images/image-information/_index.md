...
# Информация об изображении в файле PDF
...
```
Каждый оператор в PDF-файле представляет собой команду, сообщающую рендереру, как управлять графическими элементами, включая изображения.
