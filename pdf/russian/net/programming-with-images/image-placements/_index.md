...
Этот цикл проходит по каждому изображению, найденному на странице. Мы печатаем ширину, высоту, нижний левый x (LLX), нижний левый y (LLY) и разрешение изображения (как горизонтальное, так и вертикальное). Эти данные помогут вам понять размер и расположение каждого изображения внутри PDF.
