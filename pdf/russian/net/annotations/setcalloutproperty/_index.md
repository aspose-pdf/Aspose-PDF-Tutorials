...
# Установить свойство выноски в файле PDF
...
Первый шаг в нашем путешествии — инициализация нового документа PDF, в который мы добавим нашу выноску. Думайте об этом как о создании пустого холста, на котором вы можете начать добавлять элементы.
...
Конечно! Вы можете настраивать различные аспекты, такие как цвет линии, толщину, а также шрифт и стиль текста.

### Можно ли добавить несколько выносок на одну страницу?

Да, вы можете добавить столько выносок, сколько необходимо, повторяя шаги для каждой аннотации.
