...
При работе с документами PDF добавление аннотаций может быть эффективным способом выделения информации или добавления интерактивных элементов в ваши файлы. Одной из таких аннотаций является аннотация Ink, которая позволяет вам рисовать линии свободной формы в вашем PDF. Но что, если вам нужно настроить внешний вид этих линий, в частности ширину линии? В этом руководстве мы проведем вас через процесс настройки ширины линии аннотации Ink с помощью Aspose.PDF для .NET.
...
Теперь, когда все пункты готовы, мы можем создать рукописную аннотацию и добавить ее на страницу PDF-файла.
