...
- `TextFragmentAbsorber`Этот класс используется для поиска и работы с определенными фрагментами текста в документе PDF. В этом примере мы ищем слово "Estoque". Замените "Estoque" на слово или фразу, которую вы хотите найти в документе.
...
### Как настроить толщину зачеркнутой линии?
