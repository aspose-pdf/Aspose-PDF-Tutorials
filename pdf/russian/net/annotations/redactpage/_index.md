...
Чтобы начать наше путешествие, нам нужно импортировать необходимые пакеты, которые позволяют нам работать с файлами PDF в нашем приложении .NET. Откройте ваш проект C# и добавьте следующие директивы using в верхней части вашего файла кода:
...
## Шаг 4: Настройте аннотацию к редактированию
