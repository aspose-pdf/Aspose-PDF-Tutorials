...
### [Добавление прямоугольника в PDF с помощью C# – Полное руководство по программированию](./add-rectangle-to-pdf-with-c-complete-programming-guide/)
Узнайте, как добавить прямоугольник в PDF с помощью C# и Aspose.PDF .NET, следуя полному руководству по программированию.
