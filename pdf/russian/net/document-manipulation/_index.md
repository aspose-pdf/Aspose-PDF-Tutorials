...
### [Как добавить и настраивать номера страниц в PDF-файлах с помощью Aspose.PDF для .NET | Руководство по работе с документами](./add-customize-page-numbers-aspose-pdf-dot-net/)
...
### [Как сохранить измененный PDF с помощью Aspose.PDF и добавить прозрачность](./how-to-save-modified-pdf-with-aspose-pdf-and-add-transparenc/)
Узнайте, как сохранить измененный PDF и применить прозрачность к элементам с помощью Aspose.PDF для .NET.
...
Узнайте, как легко изменить цвет текста ссылок в PDF-файлах с помощью Aspose.PDF .NET. Это всеобъемлющее руководство охватывает советы по установке, внедрению и оптимизации.
...
Узнайте, как легко вставлять пустые страницы в документы PDF с помощью Aspose.PDF .NET. Следуйте этому пошаговому руководству, чтобы улучшить свои навыки работы с документами.
...
### [Освойте работу с PDF-файлами с помощью Aspose.PDF .NET: простая загрузка и изменение документов](./mastering-pdf-manipulation-aspose-net/)
...
### [Как восстановить PDF в C# – быстро исправить поврежденные PDF-файлы](./how-to-repair-pdf-in-c-fix-corrupted-pdf-files-quickly/)
Узнайте, как быстро исправить поврежденные PDF-файлы с помощью Aspose.PDF для .NET в C#.
