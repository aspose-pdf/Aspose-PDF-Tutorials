...
После установки вы можете импортировать необходимые пространства имен в начало файла C#:
...
На этом этапе мы инициализируем наш документ Aspose.PDF и откроем существующий PDF-файл, с которым собираемся работать.
...
## Шаг 3: Отображение хода выполнения на консоли
