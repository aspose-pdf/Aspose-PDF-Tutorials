...
Создание документов PDF, которые выглядят профессионально и отточенно, имеет важное значение в современном цифровом мире. Одним из ключевых аспектов достижения этого отточенного вида является обеспечение корректного внедрения шрифтов, используемых в вашем PDF. Это не только сохраняет внешний вид вашего документа на разных устройствах, но и повышает его читабельность. В этом руководстве мы рассмотрим, как внедрять шрифты при создании документов PDF с помощью Aspose.PDF для .NET. 
...
Вызывая пустой конструктор, вы создаете новый пустой PDF-документ, готовый к заполнению контентом.
...
Чтобы добавить текст в ваш PDF-файл, вам необходимо создать `TextFragment`Этот объект будет содержать текст, который вы хотите отобразить.
