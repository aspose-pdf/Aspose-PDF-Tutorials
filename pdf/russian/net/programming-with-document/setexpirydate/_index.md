...
# Установить дату истечения срока действия в PDF-файле
...
## Шаг 6: Установите JavaScript в качестве действия при открытии PDF-файла
...
Наконец, пришло время сохранить ваш PDF-документ с функцией указания даты истечения срока действия. 
