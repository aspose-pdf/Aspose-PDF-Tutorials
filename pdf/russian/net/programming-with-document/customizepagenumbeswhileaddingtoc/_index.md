---
"description": "В этом подробном руководстве вы узнаете, как настраивать номера страниц при добавлении оглавления в документы PDF с помощью Aspose.PDF для .NET."
