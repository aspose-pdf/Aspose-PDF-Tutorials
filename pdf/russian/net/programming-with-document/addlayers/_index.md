...
4. Образец PDF-документа: хотя в этом руководстве основное внимание уделяется созданию нового PDF-файла, наличие образца PDF-файла для проверки ваших слоев может оказаться полезным.
...
Вам нужно будет добавить ссылки на библиотеку Aspose.PDF. Если вы установили ее через NuGet Package Manager, вы можете пропустить этот шаг. В противном случае щелкните правой кнопкой мыши по вашему проекту в Solution Explorer, выберите «Добавить» > «Ссылка» и найдите Aspose.PDF DLL.
...
Здесь мы объединяем имя выходного файла с путем к каталогу, который мы инициализировали ранее, и сохраняем документ. Последняя строка — это просто небольшое поздравительное сообщение, подтверждающее, что ваши слои надежно спрятаны внутри вашего новенького PDF!
