...
Здесь мы установили заголовок оглавления как «Оглавление», увеличили размер шрифта и сделали его полужирным для акцента.
...
И вот оно! С Aspose.PDF для .NET добавление оглавления в PDF не только простое, но и настраиваемое. Если вам нужно создать простые навигационные ссылки или сложные структуры, этот инструмент вам поможет. Так что в следующий раз, когда вы будете работать над длинным PDF, не забудьте добавить TOC для профессионального штриха!
