...
## Шаг 3: Создание и настройка текстового фрагмента

Далее мы создадим текстовый фрагмент. Это блок текста, которым мы можем манипулировать с точки зрения цвета, размера и позиционирования.
