...
# Создание многослойного PDF-файла. Первый подход
...
Теперь давайте перейдем к коду. Мы разберем его пошагово, чтобы вам было легче следить за всем этим.
...
Здесь, `dataDir` где ваш PDF будет сохранен после создания. Вы также создаете пустой `pdf` документ с использованием `Document` класс из Aspose.PDF.

## Шаг 2: Добавьте новую страницу в свой PDF-файл
...
Сам по себе Aspose.PDF не предоставляет функцию предварительного просмотра, но вы можете открыть сохраненный файл в любой программе просмотра PDF-файлов, чтобы проверить результат.
