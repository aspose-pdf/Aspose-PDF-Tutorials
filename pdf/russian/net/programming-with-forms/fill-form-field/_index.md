...
Первый шаг в нашем путешествии — настройка каталога, в котором хранятся ваши PDF-документы. Это важно, поскольку нам нужно знать, где найти PDF-файл, которым мы хотим манипулировать.
