...
Заменять `"YOUR DOCUMENT DIRECTORY"` с фактическим путем, где находится ваш PDF-файл. Это важно, поскольку если путь неверен, программа не сможет найти ваш PDF-файл.
