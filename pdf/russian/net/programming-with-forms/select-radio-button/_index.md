...
После выбора радиокнопки последний шаг — сохранить изменения в новом файле PDF. Вы можете сохранить обновленный документ в новом файле, указав другой выходной путь:
