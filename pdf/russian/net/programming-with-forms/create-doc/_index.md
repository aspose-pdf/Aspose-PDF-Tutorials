...
```
Эта строка инициализирует новый PDF-документ. Вы можете думать об этом как о создании нового файла, в который вы добавите контент.

## Шаг 3: Добавьте страницу в документ

Теперь, когда у нас есть документ, нам нужно добавить к нему страницу. Так же, как каждому произведению искусства нужен фон, нашему PDF-файлу нужна страница!
...
Посетите [форум поддержки](https://fилиum.aspose.com/c/pdf/10) or [скачать](https://releases.aspose.com/pdf/net/) библиотеку, чтобы начать.
