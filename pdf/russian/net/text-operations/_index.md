...
### [Как преобразовать PDF в резюме с помощью Aspose.Pdf.AI на C#](./how-to-convert-pdf-to-summary-with-aspose-pdf-ai-in-c/)
Узнайте, как с помощью Aspose.Pdf.AI преобразовать PDF в краткое резюме, используя C#.
