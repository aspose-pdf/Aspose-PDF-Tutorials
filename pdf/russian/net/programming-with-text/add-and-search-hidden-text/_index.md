...
Прежде чем вы сможете начать работу с кодом, вам нужно убедиться, что вы импортировали необходимые пространства имен Aspose.PDF. Вот как это сделать:
...
Чтобы выполнить поиск текста в PDF-файле, нам сначала нужно загрузить только что созданный нами документ.
...
Наконец, не забудьте уничтожить документ, как только закончите работу.
