...
Прежде чем мы начнем, вот что вам нужно будет сделать:
...
Мы можем добавить столько позиций табуляции, сколько нам нужно. В этом примере мы добавим выровненную по центру вкладку и выровненную по левому краю вкладку.
...
- Например, в `text0`, `#$TABHead1` выровняется по первой позиции табуляции, `#$TABHead2` будет выровнен по второму и так далее.
...
Этот код добавляет каждый `TextFragment` на страницу PDF, гарантируя, что текст отформатирован в соответствии с позициями табуляции.
