...
Возможно, вам не всегда захочется искать по всему документу PDF. В этом примере мы сужаем его до определенной страницы.
...
Теперь давайте пройдемся по каждому фрагменту текста и извлечем из него такие данные, как положение, шрифт и цвет.
