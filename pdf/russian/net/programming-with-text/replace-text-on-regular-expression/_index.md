...
Этот метод извлекает все текстовые фрагменты, соответствующие регулярному выражению, из первой страницы документа. Если вы хотите выполнить поиск по всему документу, вы можете выполнить цикл по всем страницам.
