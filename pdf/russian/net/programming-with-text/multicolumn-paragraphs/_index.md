...
- Загрузите его прямо с сайта [Ссылка для скачивания Aspose](https://releases.aspose.com/pdf/net/).
...
```
Он содержит структурированное представление страницы; представьте себе, что это «скелет» нашего документа, которым мы будем манипулировать.
