...
# Получить ширину текста динамически
...
3. Базовые знания C# и .NET: знакомство с программированием на C# и платформой .NET поможет вам легче понимать примеры.
...
## Шаг 3: Создание текстового состояния
