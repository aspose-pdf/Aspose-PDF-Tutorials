...
Это помещает нашу таблицу, которая содержит скрипт LaTeX, на страницу документа. Мы почти у цели!
...
Да, для полноценного использования вам понадобится активная лицензия. Однако вы можете попробовать ее бесплатно с [временная лицензия](https://purchase.aspose.com/temporary-license/).
