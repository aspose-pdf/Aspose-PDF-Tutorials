...
Первый шаг — инициализация нового PDF-документа и добавление к нему страницы. Это служит холстом для наших плавающих боксов.
...
В этом фрагменте кода замените `"YOUR DOCUMENT DIRECTORY"` фактический путь, по которому вы хотите сохранить свой PDF-файл.

## Шаг 2: Создание первого плавающего блока.

Далее давайте создадим наш первый плавающий блок и зададим его выравнивание. Здесь содержимое будет выровнено по нижнему правому краю блока.
...
Как и в первом блоке, мы установили вертикальное выравнивание по центру и горизонтальное выравнивание по правому краю. Этот метод позволяет динамически корректировать содержимое и улучшает визуальную привлекательность.
