...
# Поворот текста с использованием фрагмента текста в файле PDF
...
Прежде чем мы погрузимся в код, давайте быстро рассмотрим инструменты и настройки, которые вам понадобятся. Вам нужно, чтобы все было готово, чтобы вы могли без усилий следовать дальше.
...
Каждая манипуляция PDF начинается с создания или загрузки PDF-документа. Здесь мы инициализируем новый PDF-документ с нуля с помощью Aspose.PDF.
...
Наконец, сохраните документ в указанном каталоге. Без этого шага вся ваша тяжелая работа испарится!
...
Конечно. Вы можете настроить шрифт каждого фрагмента текста, используя `FontRepository.FindFont` и передайте шрифт, который вы хотите применить.
