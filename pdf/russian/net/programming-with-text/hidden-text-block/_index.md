...
4. Базовые знания C#: поскольку мы будем программировать на C#, базовые знания языка помогут вам гораздо легче усвоить концепции.
...
После установки пакета следующим шагом будет импорт пространств имен в верхней части вашего файла C#. Это делает доступными все крутые функции Aspose:
...
Получив фрагмент текста, мы извлечем его с помощью следующего кода, что позволит нам производить с ним дальнейшие манипуляции:
...
Да, помимо скрытых текстовых блоков, с помощью Aspose.PDF можно добавлять кнопки, гиперссылки, аннотации и многое другое.
