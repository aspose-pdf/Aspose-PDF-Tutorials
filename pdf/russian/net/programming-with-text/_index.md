...
"linktitle": "Программирование с использованием текста"
"title": "Программирование с использованием текста"
...
# Программирование с использованием текста
...
| [Добавить упорядоченный список HTML в документы](./add-html-ordered-list-into-documents/) | Научитесь добавлять упорядоченные списки HTML в документы PDF с помощью Aspose.PDF для .NET. Ознакомьтесь с пошаговыми инструкциями в этом подробном руководстве. |  
| [Добавить HTML с помощью DOM](./add-html-using-dom/) Узнайте, как добавлять HTML-контент в документы PDF с помощью Aspose.PDF для .NET в этом пошаговом руководстве. Улучшайте свои файлы PDF с помощью динамического форматирования HTML легко. |  
...
| [Добавить границу текста в файл PDF](./add-text-border/) | Узнайте, как добавить текстовую границу в файл PDF с помощью Aspose.PDF для .NET с помощью этого пошагового руководства. Улучшите свои документы PDF. |  
...
| [Извлечь абзацы из PDF-файла](./extract-paragraphs/) | Узнайте, как извлекать абзацы из файлов PDF с помощью Aspose.PDF для .NET в этом простом руководстве. Идеально подходит для разработчиков всех уровней. |   
| [Извлечь весь текст в файл PDF](./extract-text-all/) |Узнайте, как легко извлекать текст из PDF-файлов с помощью Aspose.PDF для .NET с помощью этого пошагового руководства.|  
...
| [Скрытый текстовый блок в PDF-файле](./hidden-text-block/) | Создавайте интерактивные PDF-файлы со скрытыми текстовыми блоками с помощью Aspose.PDF для .NET. Это руководство содержит пошаговое руководство по улучшению ваших документов. |  
...
| [Создание элемента Span в Word с C# – Полное руководство](./create-span-element-in-word-with-c-complete-guide/) | Узнайте, как создать элемент span в документе Word с помощью C# – полное руководство. |  
