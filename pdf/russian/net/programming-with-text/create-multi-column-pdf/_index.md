...
Далее давайте вставим текст, содержащий HTML-теги, чтобы показать, как можно динамически форматировать текст в PDF-файле.

```csharp
// Создать строку с HTML-содержимым
...
Этот блок сохраняет PDF-файл в указанном каталоге и выводит сообщение об успешном завершении в консоль. PDF-файл теперь готов к просмотру!
