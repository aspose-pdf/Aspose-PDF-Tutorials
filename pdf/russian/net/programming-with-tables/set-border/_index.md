...
В этом примере мы указываем, что верхняя и нижняя границы должны быть двойными. Это отлично подходит для добавления акцента и визуальной глубины вашей таблице.
