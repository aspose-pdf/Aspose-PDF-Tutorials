---
"description": "Изучите пошаговые руководства по программированию с использованием таблиц в Aspose.PDF для .NET."
...
# Программирование с использованием таблиц
...
| [Получить ширину таблицы в PDF-файле](./get-table-width/) | Узнайте, как получить ширину таблицы в PDF-файле с помощью Aspose.PDF для .NET с помощью этого пошагового руководства. |  
...
| [Манипулировать таблицей в файле PDF](./manipulate-table/) | Узнайте, как работать с таблицами в PDF-файлах с помощью Aspose.PDF для .NET с помощью пошагового руководства, включая примеры кода и передовые практики. |  
| [Поля или отступы](./margins-or-padding/) | Узнайте, как управлять полями и отступами в Aspose.PDF для .NET с помощью этого комплексного пошагового руководства по созданию безупречных PDF-файлов. |  
