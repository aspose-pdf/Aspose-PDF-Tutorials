...
Прежде чем перейти к написанию кода, вам необходимо убедиться в наличии нескольких вещей, чтобы следовать этому руководству:
...
Давайте создадим три разных текстовых штампа, которые мы будем использовать в качестве заголовков. Думайте о текстовых штампах как о наклейках! Мы можем настроить их так, как захотим.
...
Теперь пришло время персонализировать наш первый заголовок. Мы зададим ему выравнивание, стиль, цвет и размер, чтобы он выделялся.
