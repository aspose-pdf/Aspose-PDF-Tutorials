...
Если вы соответствуете этим предварительным условиям, вы готовы к старту!
...
Вы можете продолжать добавлять текстовые строки! Давайте закончим оформление нашего сообщения:
