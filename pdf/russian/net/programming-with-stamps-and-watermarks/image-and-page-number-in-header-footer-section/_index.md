...
1. .NET Framework: Вам необходимо установить на компьютере любую версию .NET Framework. Если у вас ее нет, вы можете легко загрузить ее с веб-сайта Microsoft.
...
4. Файл изображения: Вам понадобится изображение, которое вы хотите поместить в заголовок вашего документа PDF, например логотип. Сохраните его в доступном каталоге. 
...
PDF — это прежде всего страницы. Давайте добавим новую страницу в наш документ, используя:
...
Видите, как это было просто? Вы установили номер страницы динамически!
