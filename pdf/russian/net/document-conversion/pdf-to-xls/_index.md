...
В этой строке мы создаем новый экземпляр `Document` class и передаем путь к нашему PDF-файлу. Это как открыть книгу; вам нужно иметь ее перед собой, чтобы читать!
