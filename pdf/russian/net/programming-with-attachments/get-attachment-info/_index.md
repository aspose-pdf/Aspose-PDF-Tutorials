...
Некоторые встроенные файлы могут иметь дополнительные параметры, которые предоставляют больше контекста о файле. Давайте проверим, существуют ли эти параметры, и распечатаем их.
