...
# Добавить элемент структуры в элемент
...
1. Visual Studio: Это ваша IDE, где вы будете писать и запускать свой код C#. Вы можете загрузить его с [Визуальная Студия](https://visualstudio.microsoft.com/) если вы еще этого не сделали.
