...
## Шаг 4: Настройте границы и заголовки таблицы
...
Этот фрагмент сохраняет файл PDF и проверяет, соответствует ли он стандартам соответствия PDF/UA. Если документ соответствует, он доступен для пользователей с ограниченными возможностями.
