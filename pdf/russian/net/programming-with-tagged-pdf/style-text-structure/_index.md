...
Эта строка инициализирует пустой PDF-документ. Думайте о нем как о чистом холсте, готовом для того, чтобы вы рисовали на нем свои идеи!
...
Наконец, сохраним наш шедевр. Используйте следующий код:
...
Aspose.PDF для .NET — это мощная библиотека, которая позволяет разработчикам создавать, редактировать, конвертировать и обрабатывать PDF-документы программным способом.
