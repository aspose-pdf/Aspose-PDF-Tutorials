...
### [Aspose.PDF を使用して PDF を検証する – C# で PDF 署名の有効性を確認する](./how-to-validate-pdf-with-aspose-pdf-check-pdf-signature-vali/)
C# で Aspose.PDF を利用し、PDF のデジタル署名が有効かどうかを検証する手順を解説します。
