...
### [Aspose.PDF for .NET を使用して PDF に透明度を追加し、矩形を描く方法](./how-to-add-transparency-to-pdf-and-draw-a-rectangle-on-pdf-w/)
Aspose.PDF for .NET を使用して、PDF に透明度を設定し矩形を描画する手順を解説します。
