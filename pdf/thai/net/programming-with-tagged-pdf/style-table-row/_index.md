...
ที่นี่เราเพียงกำลังเริ่มต้นสิ่งใหม่ `Document` วัตถุที่จะแทนไฟล์ PDF ของเรา ตรวจสอบให้แน่ใจว่าคุณได้ตั้งค่าเส้นทางไดเรกทอรีที่คุณจะบันทึกไฟล์เอาต์พุตของคุณ
...
ต่อไปเรามากำหนดโครงสร้างของตารางที่เรากำลังจะสร้างกัน ตารางทุกตารางต้องมีส่วนหัว เนื้อหา และส่วนท้าย เช่นเดียวกับโพสต์บล็อกที่จัดระบบอย่างดี!
...
ตอนนี้มาถึงส่วนที่สนุกแล้ว นั่นคือการกำหนดสไตล์ของแถว มาสร้างแถว 7 แถวพร้อมสไตล์ที่กำหนดเองกัน เราจะตั้งค่าสีพื้นหลัง ขอบ ระยะห่าง และการจัดแนวข้อความ
...
- ความสูงและการเติม: ความสูงของแถวได้รับการกำหนดแล้ว และมีการเพิ่มการเติมเพื่อให้ดูสะอาดตา
