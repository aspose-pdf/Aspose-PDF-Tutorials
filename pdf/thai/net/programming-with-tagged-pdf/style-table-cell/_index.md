...
ในขั้นตอนนี้ เราจะวนซ้ำเซลล์ส่วนหัวแต่ละเซลล์ โดยให้พื้นหลังเป็นสีเขียวเหลือง ขอบเป็นสีเทา และข้อความที่จัดชิดขวา คุณสามารถปรับคุณสมบัติเหล่านี้ให้ตรงกับการออกแบบที่คุณต้องการได้
