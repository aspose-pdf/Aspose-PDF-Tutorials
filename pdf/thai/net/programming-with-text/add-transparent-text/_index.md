...
ที่นี่เราจะเริ่มต้น `Document` วัตถุที่แสดงไฟล์ PDF ของเรา เรายังเพิ่มหน้าว่างเข้าไปด้วย ง่ายใช่ไหม?
...
// สร้างอินสแตนซ์สี่เหลี่ยมผืนผ้าที่มีขนาดที่กำหนด
...
ตอนนี้มาถึงส่วนสนุก ๆ แล้ว มาสร้างข้อความโปร่งใสและเพิ่มลงในเอกสารกัน ตรงนี้แหละที่ PDF ของคุณจะได้ข้อความที่ดูสวยงามคล้ายลายน้ำ
