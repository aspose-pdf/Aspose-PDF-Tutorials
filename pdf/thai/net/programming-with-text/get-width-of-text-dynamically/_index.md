...
เนมสเปซเหล่านี้ให้การเข้าถึงคลาสและวิธีการสำหรับการสร้างและจัดการเอกสาร PDF และองค์ประกอบข้อความ
...
อย่าลืมเปลี่ยน `"YOUR DOCUMENT DIRECTORY"` โดยมีเส้นทางไปยังไดเร็กทอรีของคุณจริง ซึ่งจะกำหนดว่าไฟล์ของคุณจะถูกอ่านและเขียนจากที่ใด
