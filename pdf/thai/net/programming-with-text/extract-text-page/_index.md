...
1. ความรู้พื้นฐานเกี่ยวกับ C#: ความคุ้นเคยกับการเขียนโปรแกรม C# จะทำให้การเดินทางราบรื่นยิ่งขึ้น หากคุณมีประสบการณ์ในการเขียนโค้ดเล็กน้อย คุณก็จะเข้ากับมันได้
...
ในการเริ่มต้นโครงการ เราจำเป็นต้องนำเข้าไลบรารีที่จำเป็น นี่คือสิ่งที่คุณจะต้องเพิ่มไว้ที่ด้านบนของไฟล์ C#:
...
เส้นนี้จะสร้างใหม่ `Document` โหลดไฟล์ PDF ที่ระบุ หากทุกอย่างเป็นไปด้วยดี คุณก็พร้อมที่จะเริ่มค้นหาข้อความแล้ว!
...
คิดถึง `TextAbsorber` เหมือนเครื่องดูดฝุ่นที่ออกแบบมาเพื่อดูดข้อความที่เป็นประโยชน์ทั้งหมดจากหน้า PDF โดยเฉพาะ 
