...
ก่อนจะเริ่มเขียนโค้ด เรามาตรวจสอบก่อนว่าคุณมีข้อมูลทั้งหมดที่จำเป็นในการปฏิบัติตามขั้นตอนต่อไปนี้:
...
- การ `TextBuilder` คลาสช่วยให้เราเพิ่มข้อความลงในหน้าเฉพาะได้ โดยผ่าน `pdfPage` เมื่อถึงตัวสร้าง เราก็พร้อมที่จะแทรกย่อหน้าของเราแล้ว
...
- การ `Save()` วิธีการเขียน PDF ลงในดิสก์ ทำให้สามารถเข้าถึงเพื่อดูได้
