...
อันดับแรก เราต้องระบุที่ตั้งของไฟล์ PDF ของเรา ซึ่งก็เหมือนกับการบอกโค้ดของคุณว่า "เฮ้ ไฟล์ PDF ของฉันอยู่ที่นี่"
...
ในบรรทัดนี้เราสร้างใหม่ `Document` โดยระบุเส้นทางแบบเต็มไปยังไฟล์ PDF ตรวจสอบให้แน่ใจว่าชื่อไฟล์ของคุณถูกต้อง (ในกรณีนี้คือ “input.pdf”) และอยู่ในไดเรกทอรีที่ระบุ
