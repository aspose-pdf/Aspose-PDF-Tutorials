...
# ฝังแบบอักษรมาตรฐานประเภท 1 ลงในไฟล์ PDF
...
สิ่งแรกที่คุณต้องทำคือระบุเส้นทางที่จัดเก็บเอกสารของคุณ นี่คือตำแหน่งที่ไลบรารี Aspose.PDF จะค้นหาไฟล์ PDF ที่คุณป้อนและจะบันทึกไฟล์ที่อัปเดต เหมือนกับการให้แผนที่แก่โค้ดของคุณเพื่อค้นหาสมบัติ!
