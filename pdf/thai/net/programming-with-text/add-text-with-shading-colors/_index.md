...
หากต้องการแรเงาข้อความเฉพาะบางส่วน เราต้องค้นหาข้อความนั้นใน PDF ซึ่ง TextFragmentAbsorber จะช่วยได้ โปรแกรมนี้เปรียบเสมือนสแกนเนอร์ที่ดูดข้อความที่คุณต้องการแก้ไข
...
## ขั้นตอนที่ 5: ใช้เงาให้กับข้อความ
...
PDF ที่แก้ไขแล้วจะถูกบันทึกด้วยชื่อ `"text_out.pdf"` ในไดเร็กทอรีที่คุณระบุไว้ก่อนหน้านี้ ตอนนี้ คุณสามารถเปิดไฟล์และดูข้อความแรเงาสวยงามได้แล้ว!
