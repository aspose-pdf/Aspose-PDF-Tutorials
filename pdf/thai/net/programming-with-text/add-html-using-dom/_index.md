...
ที่นี่เราจะสร้างตัวอย่างใหม่ `Document` วัตถุที่แสดงถึงไฟล์ PDF ที่เราจะใช้ทำงาน เอกสารว่างนี้จะทำหน้าที่เป็นผืนผ้าใบเปล่า
...
### ฉันสามารถเพิ่ม HTML ที่ซับซ้อนพร้อมรูปภาพและลิงค์ได้หรือไม่
