...
3. ไฟล์ฟอนต์ TrueType (`.ttf`) ที่เราจะใช้ในตัวอย่าง คุณสามารถใช้แบบอักษรใดก็ได้ แต่สำหรับคู่มือนี้ เราจะใช้ `HPSimplified.TTF` แบบอักษร.
...
ในขั้นตอนนี้คุณจะแทนที่ `"YOUR DOCUMENT DIRECTORY"` ด้วยเส้นทางจริงที่คุณเก็บไฟล์ของคุณ นี่จะเป็นที่ที่คุณวางไฟล์ฟอนต์ของคุณ (`HPSimplified.TTF`) และจะบันทึก PDF ไว้ที่ไหน
...
นี่คือจุดที่เวทมนตร์เกิดขึ้น เราจะระบุโหมดระยะห่างระหว่างบรรทัดสำหรับข้อความที่เราต้องการเพิ่มลงใน PDF Aspose.PDF มีตัวเลือกให้เราหลายตัวเลือก แต่ในคู่มือนี้ เราจะใช้ `LineSpacingMode.FullSize`ซึ่งทำให้มั่นใจได้ว่าระยะห่างระหว่างบรรทัดได้รับการเคารพอย่างเต็มที่
...
โค้ดนี้จะตั้งค่าโหมดระยะห่างระหว่างบรรทัดเป็น `FullSize`เพื่อให้แน่ใจว่าข้อความจะแสดงด้วยระยะห่างที่เหมาะสม มีตัวเลือกอื่นๆ เช่น `Proportional` หากคุณต้องการระยะห่างที่แตกต่างกัน แต่ตอนนี้ขอยึดตามนี้ `FullSize`-
...
และแล้วเสร็จ! คุณเพิ่งสร้างเอกสาร PDF ที่มีระยะห่างบรรทัดแบบกำหนดเองโดยใช้ Aspose.PDF สำหรับ .NET ซึ่งเป็นเครื่องมืออันทรงพลังที่ช่วยให้คุณควบคุมทุกแง่มุมของไฟล์ PDF ของคุณได้ และนี่เป็นเพียงตัวอย่างหนึ่งของสิ่งที่คุณสามารถทำได้ ตั้งแต่การจัดวางข้อความไปจนถึงการจัดรูปแบบ ความเป็นไปได้นั้นไม่มีที่สิ้นสุด
...
ใช่ คุณสามารถใช้โหมดอื่นได้ เช่น `Propหรือtional` or `Fixed` ขึ้นอยู่กับความต้องการของคุณ

### สามารถโหลดฟอนต์จากระบบแทนไฟล์ได้หรือไม่?  
...
ใช่แล้ว หากต้องการฟังก์ชันครบถ้วน คุณจะต้องมีใบอนุญาต ซึ่งคุณสามารถขอรับได้ [ที่นี่](https://purchase-aspose.com/buy).
