...
เตรียมไฟล์ PDF ต้นฉบับไว้ให้พร้อม สำหรับการสาธิต ให้ใช้ไฟล์อินพุตที่มีชื่อว่า `input.pdf`คุณสามารถสร้าง PDF ง่ายๆ ได้โดยใช้โปรแกรมแก้ไขข้อความหรือดาวน์โหลดโปรแกรมหนึ่งโปรแกรม
...
ใช่ คุณสามารถตั้งค่าสิทธิ์หลายรายการได้โดยการปรับ `DocumentPrivilege` ตั้งค่าให้เหมาะสม
