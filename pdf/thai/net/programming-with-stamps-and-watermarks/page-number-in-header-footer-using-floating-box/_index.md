...
แทนที่ `YOUR DOCUMENT DIRECTORY` พร้อมเส้นทางที่คุณเลือกที่จะบันทึกไฟล์ PDF เอาท์พุต
...
```csharp
// ค่าลอยตัวที่ระบุตำแหน่งด้านซ้ายของย่อหน้า
box1.Left = 2;
