...
1. สภาพแวดล้อม .NET: ตรวจสอบให้แน่ใจว่าคุณมีการตั้งค่าสภาพแวดล้อม .NET ที่ใช้งานได้บนเครื่องของคุณ ซึ่งอาจเป็น Visual Studio หรือ IDE อื่นที่เข้ากันได้
...
ขั้นแรก ให้เราอิมพอร์ตไลบรารีที่จำเป็นลงในโปรเจ็กต์ C# ของคุณก่อน โดยเพิ่มคำสั่ง using ต่อไปนี้ที่ด้านบนของไฟล์โค้ด:
...
- TopMargin: กำหนดระยะห่างระหว่างข้อความของเรากับด้านบนของหน้า
- การจัดแนวแนวนอน: การจัดแนวข้อความของเราให้อยู่กึ่งกลางแนวนอน
- VerticalAlignment: จะเป็นการวางข้อความของเราไว้ที่ด้านบน
...
ขั้นตอนสุดท้ายคือการบันทึกการเปลี่ยนแปลงของเราลงใน PDF ขั้นตอนนี้มีความสำคัญมาก มิฉะนั้น งานหนักทั้งหมดของเราจะสูญเปล่า!
