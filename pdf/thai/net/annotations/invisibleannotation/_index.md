...
เราปรับเปลี่ยน `dataDir` ตัวแปรเพื่อระบุชื่อไฟล์เอาท์พุต `"InvisibleAnnotation_out.pdf"`. การ `Save` วิธีการนี้จะบันทึกเอกสาร PDF ที่อัพเดตพร้อมคำอธิบายประกอบที่มองไม่เห็นไปยังไดเร็กทอรีที่ระบุ
