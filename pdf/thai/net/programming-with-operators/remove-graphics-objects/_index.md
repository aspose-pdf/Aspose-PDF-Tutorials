...
แทนที่ `"YOUR DOCUMENT DIRECTORY"` ด้วยเส้นทางจริงไปยังไฟล์ PDF ของคุณ ขั้นตอนนี้มีความสำคัญเพื่อให้โปรแกรมทราบว่าจะค้นหาไฟล์ PDF ของคุณได้ที่ใด
...
ไฟล์ PDF โดยทั่วไปจะถูกแบ่งออกเป็นหน้าต่างๆ และแต่ละหน้าจะมีคอลเลกชันตัวดำเนินการที่กำหนดว่าจะวาดอะไรบนหน้านั้นๆ ซึ่งรวมถึงกราฟิก ข้อความ และอื่นๆ อีกมากมาย
...
ตอนนี้เราได้ระบุตัวดำเนินการกราฟิกแล้ว ถึงเวลาที่จะลบตัวดำเนินการเหล่านี้แล้ว สามารถทำได้โดยการลบตัวดำเนินการเฉพาะจากคอลเลกชันตัวดำเนินการ
