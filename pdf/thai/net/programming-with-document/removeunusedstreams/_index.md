...
ในการเริ่มต้น คุณต้องนำเข้าเนมสเปซที่จำเป็นในโครงการของคุณ ซึ่งจะช่วยให้คุณจัดการและปรับเปลี่ยนเอกสาร PDF ได้
...
โดยการตั้งค่า `RemoveUnusedStreams = true`เราสั่งให้ระบบค้นหาและลบสตรีมใดๆ ที่ไม่จำเป็นอีกต่อไปในไฟล์ PDF ขั้นตอนนี้สามารถช่วยลดขนาดไฟล์และเพิ่มประสิทธิภาพได้
