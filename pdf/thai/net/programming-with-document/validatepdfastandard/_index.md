...
ในขั้นตอนนี้เราเรียก `Validate` วิธีการของเรา `pdfDocument` วัตถุ เราส่งพารามิเตอร์สองตัว: เส้นทางที่เราต้องการบันทึกผลการตรวจสอบและรูปแบบ PDF ที่เราจะตรวจสอบ ในกรณีนี้ เรากำลังตรวจสอบกับ `PdfFormat-PDF_A_1A`.
