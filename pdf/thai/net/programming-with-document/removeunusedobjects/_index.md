...
# ลบวัตถุที่ไม่ได้ใช้งานออกจากไฟล์ PDF
...
เมื่อนำเนมสเปซเหล่านี้เข้ามาแล้ว ตอนนี้คุณก็พร้อมที่จะทำงานกับ PDF ใน Aspose.PDF ได้แล้ว มาเริ่มส่วนที่สนุกกันเลย นั่นคือ การลบออบเจ็กต์ที่ไม่ได้ใช้ที่น่ารำคาญเหล่านี้ออกไป!
...
ใช่ Aspose.PDF สำหรับ .NET ต้องมีใบอนุญาตเพื่อปลดล็อกฟีเจอร์ทั้งหมด คุณสามารถขอรับได้ [ใบอนุญาตชั่วคราว](https://purchase.aspose.com/temporary-license/) หรือซื้อใบอนุญาตเต็มรูปแบบ [ที่นี่](https://purchase-aspose.com/buy).
