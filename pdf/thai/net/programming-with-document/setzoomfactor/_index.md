...
ตอนนี้มาถึงส่วนสนุกแล้ว! คุณจะสร้าง `GoToAction` ซึ่งจะกำหนดปัจจัยการซูมสำหรับ PDF ของคุณ การดำเนินการนี้จะกำหนดว่าเอกสารจะแสดงอย่างไรเมื่อเปิดขึ้น ดังต่อไปนี้:
...
และแล้วคุณก็ทำได้! คุณได้ตั้งค่าปัจจัยการซูมสำหรับไฟล์ PDF สำเร็จแล้วโดยใช้ Aspose.PDF สำหรับ .NET ฟีเจอร์ที่เรียบง่ายแต่ทรงพลังนี้สามารถปรับปรุงประสบการณ์การใช้งานของผู้ใช้สำหรับใครก็ตามที่อ่านเอกสารของคุณได้อย่างมาก การควบคุมวิธีแสดง PDF ของคุณทำให้ผู้ชมสามารถมีส่วนร่วมกับเนื้อหาของคุณได้ง่ายขึ้นตั้งแต่เริ่มต้น ดังนั้น ลองใช้เลย แล้วดู PDF ของคุณมีชีวิตขึ้นมา!
