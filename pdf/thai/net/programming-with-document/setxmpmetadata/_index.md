---
"description": "เรียนรู้วิธีตั้งค่าเมตาข้อมูล XMP ในไฟล์ PDF โดยใช้ Aspose.PDF สำหรับ .NET คำแนะนำทีละขั้นตอนนี้จะแนะนำคุณตลอดกระบวนการทั้งหมด ตั้งแต่การตั้งค่าไปจนถึงการบันทึกเอกสาร"
...
มาแยกมันออก:
- CreateDate: คุณสมบัตินี้จะเก็บวันที่สร้างไฟล์ PDF โดยจะตั้งค่าเป็นวันที่และเวลาปัจจุบัน
