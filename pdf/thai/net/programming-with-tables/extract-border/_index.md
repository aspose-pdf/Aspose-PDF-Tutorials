...
ก่อนที่เราจะเริ่มแยกไฟล์ เราต้องสร้างผืนผ้าใบสำหรับวาดภาพเสียก่อน ในโลกของ .NET เราต้องตั้งค่าวัตถุบิตแมปและกราฟิกก่อน บิตแมปแสดงถึงรูปภาพ และวัตถุกราฟิกจะช่วยให้เราสามารถวาดรูปร่าง เช่น ขอบ ที่แยกออกมาจาก PDF ได้
...
{
    // การประมวลผลคำสั่งต่างๆ เช่น การบันทึก/เรียกคืนสถานะ การวาดเส้น การเติมรูปร่าง ฯลฯ
}
```
...
หาก PDF ของคุณไม่มีเส้นขอบที่มองเห็นได้ กระบวนการแยกกราฟิกอาจไม่ให้ผลลัพธ์ใดๆ โปรดตรวจสอบให้แน่ใจว่าเนื้อหา PDF มีเส้นขอบที่วาดได้
