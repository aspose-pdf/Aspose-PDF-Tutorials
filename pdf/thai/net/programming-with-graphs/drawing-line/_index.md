...
การ `Line` คลาสใช้พิกัดสำหรับจุดเริ่มต้นและจุดสิ้นสุดของเส้นตรงนี้ `pg.Rect.LLX` และ `pg.Rect.URY` หมายถึงมุมล่างซ้ายและมุมบนขวาของหน้าตามลำดับ
...
การดำเนินการนี้จะบันทึกไฟล์ PDF ที่มีเส้นที่คุณวาดไว้ และ `Console.WriteLine` คำชี้แจงยืนยันว่าการดำเนินการสำเร็จแล้ว
...
คุณสามารถตั้งค่าได้ `Line` วัตถุ `StrokeColor` และ `LineWidth` คุณสมบัติในการปรับแต่งรูปลักษณ์ของเส้นของคุณ
