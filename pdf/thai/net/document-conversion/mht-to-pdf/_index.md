...
ขั้นแรก คุณต้องระบุเส้นทางไปยังไดเร็กทอรีเอกสารของคุณ นี่คือตำแหน่งที่ไฟล์ MHT ของคุณอยู่และตำแหน่งที่จะบันทึก PDF ที่แปลงแล้ว
...
บรรทัดนี้จะบันทึกไฟล์ PDF ที่แปลงแล้วไว้ในไดเรกทอรีเดียวกับไฟล์ MHT ของคุณ คุณสามารถเปลี่ยนชื่อไฟล์เอาต์พุตได้ตามต้องการ
...
### ไฟล์ MHT คืออะไร?
ไฟล์ MHT เป็นรูปแบบไฟล์เก็บถาวรหน้าเว็บที่บันทึกหน้าเว็บทั้งหมด รวมทั้งข้อความและรูปภาพ ในไฟล์เดียว
