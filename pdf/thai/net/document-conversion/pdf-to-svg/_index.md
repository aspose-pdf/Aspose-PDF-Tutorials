...
ก่อนที่คุณจะแปลงไฟล์ PDF คุณต้องระบุตำแหน่งจัดเก็บเอกสารของคุณก่อน ซึ่งถือเป็นเรื่องสำคัญ เนื่องจากโปรแกรมจำเป็นต้องทราบว่าจะค้นหาไฟล์ PDF อินพุตได้ที่ใด และจะบันทึกไฟล์ SVG เอาต์พุตไว้ที่ใด
...
บรรทัดนี้จะเริ่มต้นการ `SvgSaveOptions` วัตถุที่เราจะกำหนดค่าในขั้นตอนถัดไป
