...
ขั้นแรก คุณต้องระบุเส้นทางไปยังไดเร็กทอรีเอกสารซึ่งไฟล์ CGM ของคุณตั้งอยู่ ขั้นตอนนี้มีความสำคัญมาก เนื่องจากขั้นตอนนี้จะแจ้งให้โปรแกรมทราบว่าจะค้นหาไฟล์อินพุตและบันทึกไฟล์ PDF เอาต์พุตได้ที่ใด
