...
หลังจากลบไฟล์แนบแล้ว คุณต้องบันทึกไฟล์ PDF ที่อัปเดตแล้ว โดยทำได้ดังนี้:
...
บรรทัดนี้จะพิมพ์ข้อความในคอนโซลเพื่อยืนยันว่าไฟล์แนบถูกลบไปแล้ว และแสดงให้คุณเห็นว่าไฟล์ใหม่ถูกบันทึกไว้ที่ใด
