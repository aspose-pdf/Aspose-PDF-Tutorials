...
เมื่อคุณจัดการทุกสิ่งเหล่านี้เรียบร้อยแล้ว คุณก็พร้อมที่จะปลดปล่อยความคิดสร้างสรรค์ของคุณสู่โลกของ PDF แล้ว!
...
คลิกขวาที่โปรเจ็กต์ของคุณใน Solution Explorer เลือก Add > Reference และในส่วน Assemblies ให้ค้นหา Aspose.PDF หากคุณติดตั้งไลบรารีอย่างถูกต้อง ไลบรารีนั้นควรจะปรากฏในรายการ เพียงทำเครื่องหมายแล้วคลิก OK
...
ที่นี่เราสร้างสาม `RadioButtonOptionField` อินสแตนซ์สำหรับตัวเลือกแต่ละตัวของเราและตั้งชื่อให้กับตัวเลือกเหล่านั้น การใช้ชื่อที่สร้างสรรค์เหล่านี้สามารถช่วยให้ผู้ใช้สามารถเลือกสิ่งที่ต้องการได้ดีขึ้น
...
ด้วยรหัสนี้ เอกสารของคุณจะถูกบันทึกไว้ในไดเรกทอรีที่ระบุ ตอนนี้คุณสามารถเปิดไฟล์ PDF นี้เพื่อดูปุ่มตัวเลือกในการใช้งาน ขอแสดงความยินดีกับการนำ PDF แบบโต้ตอบฉบับแรกของคุณไปใช้!
