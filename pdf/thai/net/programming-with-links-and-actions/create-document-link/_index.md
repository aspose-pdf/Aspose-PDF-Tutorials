...
เมื่อคุณเตรียมลิงก์ไว้พร้อมแล้ว ก็ถึงเวลาที่จะแนบลิงก์เข้ากับหน้าเหมือนกับร้อยด้ายเข้ากับเข็ม 
...
ที่นี่ เราระบุชื่อไฟล์ใหม่ ("_out.pdf" หมายถึงเป็นสำเนาที่แก้ไข) และบันทึกเอกสาร โดยให้แน่ใจว่าผลงานหนักทั้งหมดของคุณได้รับการเก็บรักษาไว้
