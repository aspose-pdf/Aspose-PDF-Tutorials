...
ก่อนที่คุณจะเริ่มใช้บทช่วยสอนนี้ คุณต้องมีสิ่งบางอย่างดังต่อไปนี้:
...
ขั้นแรก คุณต้องโหลดไฟล์ PDF ที่คุณต้องการแก้ไข โดยทำได้ดังนี้:
...
ตอนนี้ถึงเวลาที่คุณรอคอยแล้ว—เปลี่ยนสีข้อความ! เมื่อคุณระบุส่วนข้อความภายใต้คำอธิบายลิงก์ได้แล้ว คุณสามารถเปลี่ยนสีเป็นสีที่สะดุดตาขึ้น เช่น สีแดง ได้อย่างง่ายดาย
...
ใช่ คุณสามารถเปลี่ยนสีเป็นสีใดก็ได้ที่มีใน `System.Drawing.Color` เนมสเปซ ตัวอย่างเช่น `Colหรือ-Blue` or `Color.Green`.

### ฉันสามารถอัพเดตข้อความในหลายหน้าในครั้งเดียวได้ไหม?  
