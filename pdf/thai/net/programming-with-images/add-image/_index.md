---
"description": "เรียนรู้วิธีการเพิ่มรูปภาพลงในไฟล์ PDF ด้วยโปรแกรมโดยใช้ Aspose.PDF สำหรับ .NET มีคู่มือทีละขั้นตอน ตัวอย่างโค้ด และคำถามที่พบบ่อยเพื่อให้ใช้งานได้อย่างราบรื่น"
...
หากต้องการเริ่มใช้งาน Aspose.PDF คุณต้องนำเข้าเนมสเปซที่จำเป็น โดยทำได้ดังนี้:
...
```
ในตัวอย่างนี้ เราจะเพิ่มรูปภาพลงในหน้าแรกของ PDF (หน้า[1] หมายถึงหน้าแรกเนื่องจากเป็นการสร้างดัชนีแบบใช้หนึ่งหน้า)
...
การ `ConcatenateMatrix` ตัวดำเนินการนี้ใช้สำหรับการนำการแปลงเมทริกซ์ไปใช้ เพื่อให้แน่ใจว่าวางภาพได้อย่างถูกต้อง
...
เมื่อเพิ่มภาพแล้ว ให้คืนสถานะกราฟิกก่อนหน้าโดยใช้ `GRestore` ผู้ดำเนินการ
...
ใช่ คุณสามารถเพิ่มรูปภาพหลายภาพลงในหน้าเดียวกันได้โดยการทำซ้ำขั้นตอนการโหลดและวางรูปภาพแต่ละภาพ
