...
สิ่งแรกที่เราต้องทำคือกำหนดเส้นทางไปยังโฟลเดอร์ที่เก็บไฟล์ภาพของคุณ ซึ่งจะช่วยให้เราสามารถเข้าถึงภาพเพื่อการแปลงได้อย่างถูกต้อง
...
ต่อไปเราจะสร้างเอกสาร PDF เปล่าที่จะบรรจุรูปภาพของเรา โดยใช้ `Aspose.Pdf.Document` constructor เราเริ่มต้นเอกสารเปล่า
...
ก่อนที่เราจะแทรกภาพลงใน PDF เราจะต้องอ่านภาพนั้นจากระบบไฟล์เสียก่อน เราทำได้โดยการสร้าง `FileStream` เพื่อเปิดไฟล์รูปภาพ
...
### ฉันสามารถเพิ่มรูปภาพหลาย ๆ รูปลงใน PDF เดียวด้วยวิธีนี้ได้หรือไม่?
