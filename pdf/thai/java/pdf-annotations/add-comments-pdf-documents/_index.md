...
การเพิ่มความคิดเห็นนั้นทำได้ง่าย คุณสามารถแทรกความคิดเห็น เช่น ไฮไลท์ ข้อความโน้ต หรือแสตมป์ได้โดยใช้ API ของ Aspose.PDF มาเพิ่มความคิดเห็นไฮไลท์เป็นตัวอย่าง:
