...
Aspose.PDF สำหรับ Java จะตรวจจับฟอนต์ในเอกสาร PDF โดยอัตโนมัติ ซึ่งไม่สามารถแสดงในรูปแบบ HTML ได้ โดยจะแทนที่ด้วยฟอนต์ที่ปลอดภัยสำหรับเว็บที่คล้ายคลึงกัน เพื่อให้แน่ใจว่าการแสดงผลในรูปแบบ HTML ที่แปลงแล้วนั้นมีความสอดคล้องกัน
