...
### [Aspose.Pdf를 사용하여 수정된 PDF를 저장하고 투명도 추가하는 방법](./how-to-save-modified-pdf-with-aspose-pdf-and-add-transparenc/)
Aspose.PDF를 이용해 수정된 PDF를 저장하고 투명도 효과를 적용하는 방법을 단계별로 안내합니다.
