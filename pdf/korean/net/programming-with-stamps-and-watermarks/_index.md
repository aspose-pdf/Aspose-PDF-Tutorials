...
| [C#을 사용하여 PDF에 베이츠 번호 매기기 추가 – 완전 단계별 가이드](./add-bates-numbering-to-pdf-in-c-complete-step-by-step-guide/) | Aspose.PDF for .NET을 사용해 C#에서 PDF에 베이츠 번호를 추가하는 방법을 단계별로 안내합니다. |  
