...
| [Aspose.Pdf를 사용하여 ICC 프로파일을 삽입하고 PDF를 PDF/X-1로 변환하는 방법](./how-to-embed-icc-profile-and-convert-pdf-to-pdf-x-1-with-asp/) | Aspose.PDF for .NET을 사용하여 ICC 프로파일을 삽입하고 PDF를 PDF/X-1 형식으로 변환하는 단계별 가이드입니다. |
