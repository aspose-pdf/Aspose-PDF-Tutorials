...
| [Aspose를 사용하여 PDF를 ICC와 함께 PDF/X‑1A로 변환하는 방법](./how-to-use-aspose-to-convert-pdf-to-pdf-x-1a-with-icc/) | Aspose.PDF for .NET을 사용하여 PDF를 ICC 프로파일과 함께 PDF/X‑1A 형식으로 변환하는 단계별 가이드를 제공합니다. |  
