...
| [C#를 사용한 PDF를 PDF/X‑4로 변환 – 완전한 Aspose.PDF 가이드](./convert-pdf-to-pdf-x-4-with-c-complete-aspose-pdf-guide/) | Aspose.PDF for .NET을 활용해 C#로 PDF를 PDF/X‑4 형식으로 변환하는 전체 가이드입니다. |
