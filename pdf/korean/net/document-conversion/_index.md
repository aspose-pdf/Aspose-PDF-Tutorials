...
| [PDFX4 변환 튜토리얼 – PDF 표준 설정 및 Aspose를 사용한 PDF 변환](./pdfx4-conversion-tutorial-set-pdf-standard-and-convert-pdf-u/) | Aspose.PDF for .NET을 사용하여 PDF 표준을 설정하고 PDF를 PDF/X‑4로 변환하는 단계별 가이드입니다. |  
