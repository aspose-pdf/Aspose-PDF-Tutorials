---
"description": "주석을 사용한 프로그래밍에는 주석 추가, 주석 삭제, 주석 정보 가져오기 등을 포함한 .NET용 Aspose.PDF의 API 튜토리얼과 코드 조각이 포함되어 있습니다."
...
Aspose.PDF for .NET을 사용하여 PDF 문서에 주석을 추가하는 방법을 보여주는 포괄적인 튜토리얼 모음입니다. 텍스트, 선, 원, 사각형, 다각형, 하이퍼링크 등 다양한 유형의 주석을 생성하고 조작하는 방법을 보여주는 광범위한 코드 조각을 제공합니다. 각 예제에는 완전한 C# 코드와 함께 코드의 기능 및 예상 출력에 대한 자세한 설명이 포함되어 있습니다. Aspose.PDF를 사용하여 PDF 문서에 주석을 추가하는 방법을 배우고자 하는 .NET 개발자에게 유용한 자료입니다.

## 튜토리얼
| 제목 | 설명 |
| --- | --- | 
| [PDF 주석 추가](./addannotation/) Aspose.PDF for .NET을 사용하여 PDF에 사용자 지정 주석을 쉽게 추가하는 단계별 가이드를 참고하세요. 특정 세부 정보와 아이콘을 사용하여 주석을 사용자 지정하세요. |  
| [lnk 주석 추가](./addlnkannotation/) | 이 흥미로운 단계별 가이드를 통해 Aspose.PDF for .NET을 사용하여 PDF 파일에 잉크 주석을 추가하는 방법을 알아보세요. |  
| [SWF 파일을 PDF 주석으로 추가](./addswffileasannotation/) | Aspose.PDF for .NET을 사용하여 SWF 파일을 PDF 주석으로 추가하는 방법을 알아보세요. 이 자세한 튜토리얼을 통해 대화형 멀티미디어 콘텐츠로 PDF를 더욱 풍성하게 만들어 보세요. |  
...
| [페이지에서 모든 주석 가져오기](./getallannotationsfrompage/) | Aspose.PDF for .NET을 사용하여 PDF 파일에서 주석을 추출하는 방법을 단계별 가이드로 알아보세요. 모든 수준의 개발자에게 적합합니다. |  
...
| [C#를 사용하여 PDF에 사각형 그리기 – 단계별 가이드](./draw-rectangle-on-pdf-with-c-step-by-step-guide/) Aspose.PDF for .NET을 사용하여 C#로 PDF에 사각형을 그리는 방법을 단계별로 안내합니다. |  
