...
### [Save PDF as HTML – Create PDF, add rectangle shape](./save-pdf-as-html-create-pdf-add-rectangle-shape/)
Learn how to generate a PDF, add a rectangle shape, and save it as HTML using Aspose.PDF for .NET.
