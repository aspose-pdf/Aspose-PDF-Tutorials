...
| [draw rectangle on pdf – step‑by‑step C# guide](./draw-rectangle-on-pdf-step-by-step-c-guide/) | Step‑by‑step guide to draw rectangles on PDF files using Aspose.PDF for .NET in C#. |
