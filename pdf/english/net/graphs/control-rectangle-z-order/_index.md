---
title: Create and Customize PDF with Rectangles in .NET 
weight: 7700
limit: 
description: Learn how to create a PDF document in .NET, add colorful rectangles with varying Z-indices, and save the final document using Aspose.PDF.  
...
2. Download the Aspose.PDF library from the [Aspose website](https://www.aspose.com/purchase).
