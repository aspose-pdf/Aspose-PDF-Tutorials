---
title: Adding Underlined Text in PDF with Aspose.PDF for .NET
weight: 7700
limit: 
description: Learn how to add underlined text to PDF documents using Aspose.PDF for .NET library with this step-by-step code example and instructions.
