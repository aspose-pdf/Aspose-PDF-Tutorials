---
title: Create and Modify a PDF with Images Using Aspose.PDF for .NET
weight: 7700
limit: 
description: Learn how to create a PDF document, insert an image, adjust its size, and set page properties using Aspose.PDF for .NET. Full code example included.
