---
"description": "学习如何使用 Aspose.PDF for Java 将 HTML 有序列表添加到 PDF 文档中。提供包含源代码的分步指南。"
...
接下来，您需要解析 HTML 有序列表并将其添加到 PDF 文档中。Aspose.PDF for Java 提供了一种便捷的方法，使用 `HtmlFragment` 班级。
...
在本教程中，我们学习了如何使用 Aspose.PDF for Java 将 HTML 有序列表添加到 Java 文档中。这个功能强大的库可以让您轻松操作 PDF 文档并创建动态内容。
...
Aspose.PDF for Java 是一个商业库，您可能需要针对某些使用场景购买许可证。请参阅其网站以获取许可信息。

### Aspose.PDF for Java 还提供了其他功能吗？

是的，Aspose.PDF for Java 提供了丰富的 PDF 文档处理功能，包括文本提取、PDF 转换等。您可以访问以下链接查看文档： [https://reference.aspose.com/pdf/java/](https://reference.aspose.com/pdf/java/) 了解详细信息。
