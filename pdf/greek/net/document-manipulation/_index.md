...
### [Πώς να συνενώσετε και να εισαγάγετε κεντές σελίδες σε PDF χρησιμοποιώντας .NET και Aspose.PDF](./master-net-pdf-manipulation-concatenate-insert-blank-pages-asposepdf/)
...
### [Πώς να αποθηκεύσετε τροποποιημένο PDF με το Aspose.Pdf και να προσθέσετε διαφάνεια](./how-to-save-modified-pdf-with-aspose-pdf-and-add-transparenc/)
Μάθετε πώς να αποθηκεύσετε ένα τροποποιημένο PDF και να εφαρμόσετε διαφάνεια χρησιμοποιώντας το Aspose.PDF για .NET.
