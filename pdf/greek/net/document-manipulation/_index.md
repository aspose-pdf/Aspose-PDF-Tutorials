...
### [Προσθήκη ορθογωνίου σε PDF με C# – Πλήρης οδηγός προγραμματισμού](./add-rectangle-to-pdf-with-c-complete-programming-guide/)
Μάθετε πώς να προσθέσετε ορθογώνιο σε PDF χρησιμοποιώντας C# και το Aspose.PDF .NET με πλήρη οδηγό κώδικα.
