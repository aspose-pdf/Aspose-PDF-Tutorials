...
# Thêm văn bản xoay trong PDF bằng Java
...
Hãy bắt đầu bằng cách tạo một tài liệu PDF mới bằng Aspose.PDF. Tài liệu này sẽ đóng vai trò là khung cho văn bản xoay của chúng ta.
...
Cuối cùng, lưu tài liệu PDF có văn bản đã xoay:
