...
3. Thư viện Aspose.PDF: Nhận thư viện Aspose.PDF. Bạn có thể [tải xuống ở đây](https://releases.aspose.com/pdf/net/) để bắt đầu. Phiên bản đánh giá cũng có sẵn [đây](https://releases.aspose.com/).
...
Sau khi cấu hình các tùy chọn và cài đặt trình xử lý tiến trình, cuối cùng chúng ta có thể lưu tài liệu và xem quá trình chuyển đổi diễn ra.
...
Để yêu cầu cấp giấy phép tạm thời để đánh giá, bạn có thể theo liên kết này: [Giấy phép tạm thời](https://purchase.aspose.com/temporary-license/).
