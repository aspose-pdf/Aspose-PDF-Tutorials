...
```csharp
WebRequest request = WebRequest.Create("https://en.wikipedia.org/wiki/Trang_chính");
...
Sau khi nội dung HTML được tải xong, chúng ta có thể tạo tài liệu PDF từ nội dung đó:
