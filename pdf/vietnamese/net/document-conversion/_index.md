...
| [Cách sử dụng Aspose để chuyển đổi PDF sang PDF/X‑1A với ICC](./how-to-use-aspose-to-convert-pdf-to-pdf-x-1a-with-icc/) | Hướng dẫn chi tiết cách chuyển đổi PDF sang PDF/X‑1A bằng Aspose với hồ sơ ICC. |
