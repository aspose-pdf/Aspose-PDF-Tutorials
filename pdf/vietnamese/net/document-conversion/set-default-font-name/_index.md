...
Cuối cùng, khi mọi thứ đã được thiết lập xong, chúng ta có thể kết xuất trang đầu tiên của tài liệu PDF thành hình ảnh và lưu nó bằng luồng tệp đã tạo trước đó.
