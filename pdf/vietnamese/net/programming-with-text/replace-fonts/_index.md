...
# Thay thế phông chữ trong tệp PDF
...
3. Giấy phép hợp lệ: Trong khi Aspose.PDF cung cấp bản dùng thử miễn phí, một số tính năng nâng cao có thể yêu cầu giấy phép. Bạn có thể nhận được [giấy phép tạm thời](https://purchase.aspose.com/temphoặcary-license/) or [mua giấy phép đầy đủ](https://purchase.aspose.com/buy).
...
Bây giờ, chúng ta hãy phân tích các bước để thay thế phông chữ trong tệp PDF. Chúng ta sẽ sử dụng một ví dụ trong đó chúng ta thay thế tất cả các trường hợp của phông chữ có tên là Arial, Bold bằng Arial. Đây là cách bạn thực hiện:
...
Sau khi thay đổi phông chữ hoàn tất, hãy lưu tệp PDF đã cập nhật.
