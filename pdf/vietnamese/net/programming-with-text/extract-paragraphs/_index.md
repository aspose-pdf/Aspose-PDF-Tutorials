...
3. Tệp PDF: Chuẩn bị sẵn một tài liệu PDF mẫu để kiểm tra. Nếu bạn không có, hãy tạo một tệp PDF văn bản đơn giản hoặc tải xuống một mẫu từ web.
...
Bước cuối cùng là biên dịch ứng dụng của bạn và chạy nó để xem kết quả. Nếu mọi thứ được thiết lập đúng, khi bạn thực thi mã, bạn sẽ thấy các đoạn trích xuất từ PDF của mình được hiển thị trong cửa sổ bảng điều khiển.
