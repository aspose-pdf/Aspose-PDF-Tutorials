...
Trước tiên, bạn cần thiết lập thư mục lưu trữ tài liệu PDF của mình. Điều này có nghĩa là mã của bạn cần biết nơi tìm tệp PDF bạn muốn chỉnh sửa.
...
Bây giờ, chúng ta sẽ tạo một con dấu văn bản để áp dụng sau vào tài liệu PDF của mình.
...
Bây giờ là lúc thêm con dấu vào một trang cụ thể của tài liệu PDF.
