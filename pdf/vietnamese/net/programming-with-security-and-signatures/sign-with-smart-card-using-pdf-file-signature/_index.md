...
# Ký bằng thẻ thông minh sử dụng chữ ký tệp PDF
...
Bây giờ, hãy thiết lập giao diện cho chữ ký của chúng ta. Đây là nơi bạn có thể tùy chỉnh giao diện chữ ký của mình trên tài liệu.
