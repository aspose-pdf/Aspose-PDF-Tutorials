...
Dòng mã này sẽ thêm tệp được chỉ định dưới dạng tệp nhúng vào tài liệu PDF.
...
Thêm tệp đính kèm vào tệp PDF bằng Aspose.PDF cho .NET là một quy trình đơn giản có thể cải thiện đáng kể chức năng của tài liệu của bạn. Bằng cách làm theo các bước được nêu trong hướng dẫn này, bạn có thể dễ dàng đính kèm tệp vào tệp PDF của mình, giúp chúng có nhiều thông tin hơn và hữu ích hơn cho đối tượng của bạn. Cho dù bạn đang làm việc trên báo cáo, bản trình bày hay bất kỳ loại tài liệu nào khác, tính năng này có thể là một công cụ thay đổi cuộc chơi.
