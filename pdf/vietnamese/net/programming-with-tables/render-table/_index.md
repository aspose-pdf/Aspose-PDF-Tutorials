...
# Hiển thị bảng trong tài liệu PDF
...
Bây giờ, chúng ta hãy tạo một bảng thứ hai có nội dung khác và thêm vào một trang mới:
...
Có, phiên bản dùng thử có thể có một số hạn chế nhất định, chẳng hạn như đóng dấu bản quyền trên các tài liệu đã tạo. Để có đầy đủ chức năng, hãy cân nhắc việc xin giấy phép tạm thời [đây](https://purchase.aspose.com/temporary-license/).
