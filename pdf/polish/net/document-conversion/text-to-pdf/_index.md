...
Zanim napiszemy jakikolwiek kod, skonfigurujmy strukturę naszego projektu. Utwórz nową aplikację konsolową C# w Visual Studio. To będzie środowisko, w którym zaimplementujemy naszą logikę konwersji PDF.

## Krok 2: Zdefiniuj katalog dokumentów
tym kroku zdefiniujemy ścieżkę do katalogu, w którym znajduje się nasz plik tekstowy. Jest to kluczowe, ponieważ musimy odczytać zawartość pliku tekstowego przed przekonwertowaniem go na PDF.
...
Ten wiersz dodaje nową stronę do `Pages` kolekcji naszego dokumentu. Można to sobie wyobrazić jako dodanie pustego płótna, na którym umieścimy nasz tekst.
...
Z naszym `TextFragment` gotowe, czas dodać je do strony, którą stworzyliśmy wcześniej.
