...
2. Aspose.PDF dla .NET: Musisz pobrać i zainstalować bibliotekę Aspose.PDF. Najnowszą wersję możesz pobrać ze strony [link do pobrania](https://releases.aspose.com/pdf/net/).
