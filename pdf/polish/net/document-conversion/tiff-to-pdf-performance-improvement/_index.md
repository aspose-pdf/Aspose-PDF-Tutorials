...
Zastępować `"YOUR DOCUMENT DIRECTORY"` z rzeczywistą ścieżką do plików TIFF. Stąd będą pobierane Twoje obrazy.
...
W pętli pierwszym zadaniem jest załadowanie każdego pliku TIFF do tablicy bajtów. Jest to kluczowe dla wydajnego przetwarzania danych obrazu.
...
Ten krok zapewnia prawidłowe wyświetlanie obrazów w pliku PDF, bez ucięć ani zniekształceń.
...
## Krok 11: Zoptymalizuj obraz pod kątem wydajności
