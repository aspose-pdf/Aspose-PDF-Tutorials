...
Zastępować `"YOUR DOCUMENT DIRECTORY"` rzeczywistą ścieżką, gdzie znajduje się Twój plik EPUB. Może to być coś takiego `C:\\Documents\\` lub dowolna inna ścieżka w twoim systemie.
