...
Ten wiersz da ci tablicę nazw plików, które pasują do formatu JPG. Upewnij się, że twój katalog zawiera jakieś obrazy JPG, aby to zadziałało!
...
masz to! Udało Ci się utworzyć dokument PDF przy użyciu Aspose.PDF dla .NET, ustawiając orientację strony na podstawie wymiarów obrazów. Ta potężna biblioteka otwiera świat możliwości pracy z plikami PDF w Twoich aplikacjach. Niezależnie od tego, czy generujesz raporty, faktury czy jakikolwiek inny typ dokumentu, Aspose.PDF ma dla Ciebie rozwiązanie.
