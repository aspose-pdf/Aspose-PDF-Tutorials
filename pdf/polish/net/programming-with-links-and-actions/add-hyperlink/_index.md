...
Zastępować `YOUR DOCUMENT DIRECTORY` z rzeczywistą ścieżką, w której chcesz zapisać swoje pliki PDF. Ta ścieżka pomoże Ci poruszać się po plikach, gdy będziemy czytać i pisać nasze pliki PDF.
...
Tutaj tworzymy prostokąt zaczynający się od `(100, 100)` i rozciąga się do `(300, 300)`. Dostosuj te liczby, aby zmienić rozmiar i lokalizację swojego łącza.
...
W ten sposób powstaje niewidoczna ramka łącza, która doskonale komponuje się z projektem PDF.
...
W tym momencie wcielimy w życie wszystko, co stworzyliśmy, dodając hiperłącze do zbioru adnotacji konkretnej strony:
