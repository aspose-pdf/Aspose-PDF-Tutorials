...
Otwórz swoje ulubione środowisko IDE C# (np. Visual Studio) i utwórz nowy projekt. Wybierz aplikację konsolową, aby ułatwić testowanie naszego kodu.
