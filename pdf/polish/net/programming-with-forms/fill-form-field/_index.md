...
Pierwszym krokiem w naszej podróży jest skonfigurowanie katalogu, w którym przechowywane są dokumenty PDF. Jest to kluczowe, ponieważ musimy wiedzieć, gdzie znaleźć plik PDF, którym chcemy manipulować.
