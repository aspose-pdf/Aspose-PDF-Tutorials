...
W tym kroku zastosujemy czcionkę do pola, ustawiając jej rozmiar na `10`i używając `System.Drawing.Color.Black` aby ustawić kolor tekstu na czarny. Możesz łatwo modyfikować te wartości, aby dopasować je do swoich potrzeb.
...
### Czy mogę zmienić rozmiar i kolor czcionki pól formularza za pomocą Aspose.PDF?
...
Jeśli czcionka nie jest dostępna, Aspose.PDF wyrzuci wyjątek. Upewnij się, że czcionka, której próbujesz użyć, jest zainstalowana w systemie.
