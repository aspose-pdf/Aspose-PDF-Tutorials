...
Dobrze! Teraz jesteśmy gotowi, aby zająć się procesem konwersji. Podzielmy go na łatwe do naśladowania kroki.
...
tym przypadku tworzymy obraz EMF o szerokości 500 pikseli i wysokości 700 pikseli. Możesz modyfikować te wymiary zgodnie z potrzebami swojego projektu.

## Krok 6: Przetwórz stronę PDF

To jest ekscytująca część! Przekonwertujesz żądaną stronę pliku PDF do formatu EMF. 
...
Ta wiadomość to doskonały sposób, aby zapewnić siebie lub osoby korzystające z Twojego programu, że wszystko poszło zgodnie z planem.
