...
Teraz, gdy wszystko już skonfigurowałeś, omówmy krok po kroku proces wyodrębniania numerów stron zakładek.
...
Ten krok pobiera wszystkie zakładki z pliku PDF i zapisuje je w zmiennej o nazwie `bookmarks`. Ta zmienna będzie przechowywać wszystkie informacje o zakładkach, które przetworzymy w następnym kroku.
