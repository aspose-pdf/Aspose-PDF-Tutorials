...
Zastępować `"YOUR DOCUMENT DIRECTORY"` z rzeczywistą ścieżką, w której przechowywany jest plik PDF. Ten krok jest kluczowy, ponieważ informuje program, gdzie znaleźć plik PDF, z którym chcesz pracować.
