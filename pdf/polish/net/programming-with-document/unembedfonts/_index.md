...
Zastępować `"YOUR DOCUMENT DIRECTORY"` rzeczywistą ścieżką, w której znajduje się Twój plik PDF. Jest to kluczowe, ponieważ program musi wiedzieć, gdzie znaleźć plik PDF, który chcesz zoptymalizować.
