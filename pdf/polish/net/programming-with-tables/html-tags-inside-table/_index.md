...
Pamiętaj o wymianie `"YOUR DOCUMENT DIRECTORY"` z rzeczywistą ścieżką, pod którą chcesz zapisać plik PDF. Jest to niezbędne, aby po wygenerowaniu dokumentu można było go łatwo zlokalizować.
...
Szerokość kolumn można kontrolować za pomocą `ColumnWidths` właściwość poprzez określenie szerokości każdej kolumny.
