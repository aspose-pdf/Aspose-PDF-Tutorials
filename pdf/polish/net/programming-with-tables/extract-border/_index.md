...
Ten kod ładuje `input.pdf` plik z określonego katalogu. Upewnij się, że ścieżka do pliku jest poprawna, w przeciwnym razie możesz otrzymać błąd „plik nie znaleziony”.
