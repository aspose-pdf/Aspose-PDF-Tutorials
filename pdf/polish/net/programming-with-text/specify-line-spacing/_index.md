...
W swoim projekcie C# musisz zaimportować przestrzenie nazw Aspose.PDF, aby pracować z funkcjonalnościami PDF. Oto, jak to zrobić:
...
Tak, możesz używać innych trybów, takich jak `PropLubtional` or `Fixed` w zależności od Twoich potrzeb.
