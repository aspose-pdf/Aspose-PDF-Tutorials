...
# Dodaj obramowanie tekstu w pliku PDF
...
W tym kodzie tworzymy nowy `TextFragment` obiekt z tekstem „main text”. Jego pozycję na stronie ustalamy również za pomocą `Position` Klasa. Współrzędne (100, 600) określają, gdzie tekst zostanie umieszczony na stronie.
...
Tak! Aspose oferuje [bezpłatny okres próbny](https://releases.aspose.com/) ich biblioteki PDF, co pozwoli Ci przetestować jej funkcje przed dokonaniem zakupu.
