...
### [Dodaj numer strony w PDF za pomocą Java](./add-page-number-stamp-in-pdf-using-java/)
...
### [Wyodrębnij tekst z adnotacji stempla w pliku PDF za pomocą Java](./extract-text-from-stamp-annotation-in-pdf-using-java/)
