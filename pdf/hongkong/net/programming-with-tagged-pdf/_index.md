...
| [使用 Aspose 建立 Span 元素 PDF – 載入 PDF 並標記內容](./create-span-element-pdf-with-aspose-load-pdf-aspose-and-tag/) |在本教學中了解如何使用 Aspose.PDF for .NET 載入 PDF 並建立 Span 元素以標記內容。 |  
