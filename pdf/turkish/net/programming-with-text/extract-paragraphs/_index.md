...
Bu satırda yeni bir tane oluşturuyoruz `Document` PDF dosyasının tam yolunu sağlayarak örnek. Dosyanızın doğru şekilde adlandırıldığından (bu durumda, “input.pdf”) ve belirtilen dizinde bulunduğundan emin olun.
...
İşte sihrin başladığı yer burası! `Visit` yöntem belgeyi inceler ve paragraf verilerini çıkarılmaya hazırlar.
...
- StringBuilder: Paragraf metnimizi etkili bir şekilde oluşturmak için bunu kullanırız.
