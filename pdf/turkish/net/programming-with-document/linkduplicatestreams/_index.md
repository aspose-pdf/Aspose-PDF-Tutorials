...
"linktitle": "Bağlantı Yinelenen Akışlar"
"second_title": "Aspose.PDF for .NET API Referansı"
"title": "Bağlantı Yinelenen Akışlar"
...
Şimdi, optimizasyon seçeneklerini ayarlamanın zamanı geldi. Bir örneğini oluşturacaksınız `OptimizationOptions` ve ayarla `LinkDuplcateStreams` mülk `true`.
...
Evet, bir PDF dosyaları listesi arasında geçiş yapabilir ve her birine aynı optimizasyon sürecini uygulayabilirsiniz.
