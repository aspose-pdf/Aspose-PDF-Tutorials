...
Açıklama: Her satır belgenin belirli bir özelliğini ayarlar. Örneğin, `docInfo.Author` yazarın adını belirlerken, `docInfo.CreationDate` belgenin oluşturulduğu tarihi ayarlar. Bu değerleri gerektiği gibi özelleştirebilirsiniz.
