...
2. .NET için Aspose.PDF: Aspose.PDF kütüphanesini indirip yüklemeniz gerekecek. En son sürümü şu adresten edinebilirsiniz: [Aspose PDF sürüm sayfası](https://releases.aspose.com/pdf/net/).
...
Son olarak, kullanıcıya PDF dosyasının şifrelenmiş olup olmadığını bildirmek isteyeceksiniz. Bunu basit bir şekilde yapabilirsiniz `Console.WriteLine` ifade.
...
### Kodlama yapmadan bir PDF'in şifreli olup olmadığını nasıl kontrol edebilirim?
