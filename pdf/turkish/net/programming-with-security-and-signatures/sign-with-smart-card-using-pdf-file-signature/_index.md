...
# PDF Dosya İmzası Kullanarak Akıllı Kartla İmzalayın
...
```
Yeni bir örnek oluşturuyoruz `PdfFileSignature` imzalanmış belge için. Daha sonra belgede bulunan tüm imzaların adlarını alırız.
