...
C# kodunuzda bir örnek oluşturacaksınız `PclLoadOptions` nesne. Bu nesne, Aspose'a dönüştürme işlemi sırasında PCL dosyasını nasıl işleyeceğini söylediği için önemlidir. Bunu nasıl yapacağınız aşağıda açıklanmıştır:
