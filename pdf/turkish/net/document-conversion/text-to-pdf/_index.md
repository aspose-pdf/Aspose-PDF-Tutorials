...
Bu yakalama bloğu, PDF oluşturma işlemi sırasında ortaya çıkabilecek sorunları gidermenize yardımcı olarak, herhangi bir hata mesajını konsola yazdıracaktır.
