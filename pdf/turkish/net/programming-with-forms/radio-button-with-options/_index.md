...
Bu satır, daha önce oluşturduğumuz hücrelere biçimlendirilmiş seçenekleri ekleyerek, bunları tablomuzda düzgün bir şekilde düzenler.
...
Bu kodla belgeniz belirtilen dizine kaydedilecektir. Artık bu PDF dosyasını açarak radyo düğmelerinizi eylem halinde görebilirsiniz. İlk etkileşimli PDF'nizi uyguladığınız için tebrikler!
