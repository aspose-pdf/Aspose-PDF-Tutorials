...
5. Geçici veya Tam Lisans – Değerlendirme sınırlarını kaldırmak için bir tane edinin [geçici lisans](https://purchase.aspose.com/tempveyaary-license/) or [satın almak](https://purchase.aspose.com/buy) tam sürüm.
...
PDF'ler birden fazla sayfaya sahip olabilir, değil mi? Bu yüzden, her bir sayfayı dolaşıp ayrı ayrı BMP görüntülerine dönüştürmemiz gerekir. Bu şekilde, her sayfa için ayrı bir görüntü elde ederiz.
...
### Birden fazla resim yerine tüm PDF'i tek bir resim haline dönüştürebilir miyim?
Hayır, Aspose.PDF her sayfayı ayrı ayrı işler. Tek bir görüntüye ihtiyacınız varsa, dönüştürmeden sonra bir görüntü işleme aracı kullanarak bunları birleştirmeniz gerekir.
