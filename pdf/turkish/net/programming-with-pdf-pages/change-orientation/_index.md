...
Yapmamız gereken ilk şey, değiştirmek istediğiniz PDF dosyasını yüklemektir. Bunu kullanabilirsiniz `Document` PDF'nizi açmak için Aspose.PDF ad alanından sınıf.
...
Ve işte karşınızda! .NET için Aspose.PDF kullanarak bir PDF dosyasının sayfa yönünü değiştirmek, belgeyi yüklemek, sayfalar arasında dolaşmak, MediaBox'ı ayarlamak ve güncellenen dosyayı kaydetmek kadar basittir. Kötü taranmış bir belgeyle uğraşıyor olun veya biçimlendirme ihtiyaçlarınıza uyması için sayfaları döndürmeniz gereksin, bu adım adım kılavuz size yardımcı olacaktır.
