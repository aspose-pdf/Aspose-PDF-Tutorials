...
table1.Margin.Top = 300; // Masanızın üstünde biraz yer açar.
```

## Adım 5: Tabloyu Sayfaya Ekleyin

Tablo oluşturulduktan sonraki adım, daha önce oluşturduğumuz sayfaya eklemektir.
