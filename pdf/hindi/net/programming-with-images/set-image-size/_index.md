...
The `FixWidth` और `FixHeight` गुण आपको छवि के सटीक आयामों को बिंदुओं में सेट करने की अनुमति देते हैं। इस उदाहरण में, हम छवि का आकार 100x100 बिंदुओं पर बदल रहे हैं। आप इन मानों को अपनी ज़रूरतों के हिसाब से समायोजित कर सकते हैं।
...
The `Paragraphs.Add()` विधि हमें पृष्ठ पर छवि जोड़ने की अनुमति देती है। `Paragraphs` संग्रह को आइटम की सूची के रूप में पीडीएफ पृष्ठ पर प्रस्तुत किया जाएगा। हम इस संग्रह में कई तत्व जोड़ सकते हैं, जैसे कि छवियाँ, पाठ और आकृतियाँ।
...
आप या तो सेटिंग करके पहलू अनुपात को बनाए रख सकते हैं `FixWidth` या `FixHeight` जबकि अन्य आयाम को अपरिवर्तित छोड़ दें।
