...
इस ट्यूटोरियल में, हम आपको .NET के लिए Aspose.PDF का उपयोग करके एक इमेज स्ट्रीम को PDF फ़ाइल में बदलने के तरीके के बारे में चरण-दर-चरण मार्गदर्शन करेंगे। हम आवश्यक वातावरण सेट अप करके शुरू करेंगे, फिर कोड को छोटे-छोटे हिस्सों में चलाएँगे, हर चरण को विस्तार से समझाएँगे।
...
2. विकास पर्यावरण: आपको .NET स्थापित के साथ Visual Studio जैसे IDE की आवश्यकता होगी।
...
The `Pages.Add()` विधि हमारे पीडीएफ दस्तावेज़ के भीतर एक नया पृष्ठ बनाती है। इस पृष्ठ को एक खाली कैनवास के रूप में सोचें जहाँ छवि जाएगी।
...
The `FileStream` में निर्दिष्ट निर्देशिका से छवि फ़ाइल पढ़ता है `dataDir`सुनिश्चित करें कि छवि फ़ाइल का नाम सही है - यहाँ, हम उपयोग कर रहे हैं `aspose.jpg`.
...
The `Image` Aspose.PDF लाइब्रेरी से क्लास का उपयोग उस छवि को दर्शाने के लिए किया जाता है जिसे PDF में एम्बेड किया जाएगा। `imageht` ऑब्जेक्ट मूलतः पीडीएफ में छवि के लिए एक प्लेसहोल्डर है।
...
The `Paragraphs.Add()` विधि पृष्ठ में छवि ऑब्जेक्ट सम्मिलित करती है, जो पीडीएफ खोले जाने पर छवि प्रदर्शित करेगी।
...
The `Save()` विधि निर्दिष्ट नाम के साथ पीडीएफ फ़ाइल आउटपुट करती है। यहाँ, पीडीएफ को इस रूप में सहेजा जाता है `ConvertMemoryStreamImageToPdf_out.pdf` छवि फ़ाइल के समान निर्देशिका में.
