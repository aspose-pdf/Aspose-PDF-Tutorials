...
```
The `Document` Aspose.PDF से क्लास का उपयोग मौजूदा PDF फ़ाइल को खोलने और उसके साथ काम करने के लिए किया जाता है। आपको वह निर्देशिका पथ निर्दिष्ट करना होगा जहाँ आपका PDF स्थित है।
...
इसके बाद, आपको यह निर्दिष्ट करना होगा कि आप पीडीएफ में किस पेज पर छवि जोड़ना चाहते हैं। Aspose.PDF आपको शून्य-आधारित अनुक्रमण का उपयोग करके दस्तावेज़ में किसी भी पृष्ठ तक पहुँचने की अनुमति देता है।

```csharp
// वह पृष्ठ प्राप्त करें जहाँ छवि जोड़ने की आवश्यकता है
Page page = pdfDocument.Pages[1];
```
इस उदाहरण में, हम छवि को पीडीएफ के पहले पृष्ठ पर जोड़ रहे हैं (पृष्ठ[1] पहले पृष्ठ को संदर्भित करता है क्योंकि यह एक-आधारित अनुक्रमण है)।
...
```
The `FileStream` क्लास का उपयोग इमेज फ़ाइल को खोलने के लिए किया जाता है। इमेज फ़ाइल (`aspose-logo.jpg`) को निर्दिष्ट निर्देशिका से लोड किया जाता है और रीड मोड में खोला जाता है (`FileMode.Open`).
...
```
The `GSave` ऑपरेटर वर्तमान ग्राफिकल सेटिंग्स को सहेजता है, जो बाद में आपको उन्हें पुनर्स्थापित करने की अनुमति देगा, यह सुनिश्चित करते हुए कि छवि की स्थिति पृष्ठ पर अन्य सामग्री को बाधित नहीं करती है।
...
```
The `Rectangle` पीडीएफ पृष्ठ पर छवि के निर्देशांक को परिभाषित करता है, और `Matrix` सही स्केलिंग और स्थिति सुनिश्चित करता है।

## चरण 8: छवि प्लेसमेंट के लिए मैट्रिक्स को संयोजित करें

The `ConcatenateMatrix` ऑपरेटर का उपयोग मैट्रिक्स रूपांतरण को लागू करने के लिए किया जाता है, जिससे यह सुनिश्चित होता है कि छवि सही ढंग से रखी गई है।
...
अंत में, का उपयोग करें `Do` वास्तव में छवि को पीडीएफ पृष्ठ पर प्रस्तुत करने के लिए ऑपरेटर का उपयोग किया जाता है।
...
```
The `Do` ऑपरेटर पिछले मैट्रिक्स रूपांतरण द्वारा परिभाषित स्थान पर छवि खींचता है।
...
```
यह चरण सुनिश्चित करता है कि ग्राफ़िक्स स्थिति में किए गए कोई भी परिवर्तन (जैसे रूपांतरण या स्केलिंग) पूर्ववत कर दिए जाएं, जिससे दस्तावेज़ का शेष भाग अप्रभावित रहे।

## चरण 11: अपडेट किए गए PDF दस्तावेज़ को सहेजें

अंत में, नई जोड़ी गई छवि के साथ पीडीएफ को एक फ़ाइल में सेव करें।
...
```
The `Save` विधि का उपयोग पीडीएफ दस्तावेज़ को जोड़ी गई छवि के साथ सहेजने के लिए किया जाता है, और अद्यतन की गई फ़ाइल को "AddImage_out.pdf" नाम से सहेजा जाता है।
