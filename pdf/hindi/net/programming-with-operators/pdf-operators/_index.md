...
एक बार जब आपके पास ये पूर्वापेक्षाएँ पूरी हो जाएँ, तो आप एक पेशेवर की तरह PDF में हेरफेर शुरू करने के लिए पूरी तरह तैयार हैं!
...
अब जबकि हमारी डायरेक्टरी सेट हो गई है, तो अब समय है उस पीडीएफ दस्तावेज़ को खोलने का जिस पर हम काम करना चाहते हैं। हम इसका उपयोग करेंगे `Document` हमारी पीडीएफ फाइल लोड करने के लिए Aspose.PDF से क्लास का उपयोग करें।
...
इससे पहले कि हम अपनी PDF में कोई छवि जोड़ सकें, हमें यह परिभाषित करना होगा कि हम इसे वास्तव में कहाँ प्रदर्शित करना चाहते हैं। इसमें उस आयताकार क्षेत्र के लिए निर्देशांक सेट करना शामिल है जहाँ छवि रखी जाएगी।
...
The `GSave` ऑपरेटर ग्राफ़िक्स संदर्भ की वर्तमान स्थिति को सहेजता है, जिससे हमें मूल स्थिति को खोए बिना अस्थायी परिवर्तन करने की अनुमति मिलती है।
...
अब आता है रोमांचक हिस्सा: पीडीएफ पर छवि बनाना। हम इसका उपयोग करेंगे `Do` ऑपरेटर को यह कार्य पूरा करना होगा।
...
The `Do` ऑपरेटर हमारे द्वारा संसाधनों में जोड़ी गई छवि का नाम लेता है और उसे निर्दिष्ट स्थान पर पृष्ठ पर खींचता है।
