...
अब जब हमने डायरेक्टरी स्थापित कर ली है, तो उस पीडीएफ दस्तावेज़ को खोलने का समय आ गया है जिसके साथ आप काम करना चाहते हैं।
...
यहाँ, हम एक नया निर्माण कर रहे हैं `Document` ऑब्जेक्ट जो आपकी पीडीएफ फाइल को लोड करता है। इसे पढ़ना शुरू करने के लिए किताब खोलने के रूप में सोचें।
...
अंत में, आइए पीडीएफ दस्तावेज़ में किए गए परिवर्तनों को सुरक्षित कर लें।
...
हां, आप चाइल्ड बुकमार्क बनाने और जोड़ने के चरणों को दोहराकर एक ही पैरेंट बुकमार्क के अंतर्गत अनेक चाइल्ड बुकमार्क बना सकते हैं।
