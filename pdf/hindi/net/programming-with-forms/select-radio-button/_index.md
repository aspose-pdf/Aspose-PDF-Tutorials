...
2. IDE: आपके C# कोड को लिखने और चलाने के लिए विजुअल स्टूडियो जैसा एक एकीकृत विकास वातावरण (IDE)।
...
रेडियो बटन का चयन करने के बाद, अंतिम चरण परिवर्तनों को एक नई पीडीएफ फाइल में सहेजना है। आप एक अलग आउटपुट पथ प्रदान करके अपडेट किए गए दस्तावेज़ को एक नई फ़ाइल में सहेज सकते हैं:
