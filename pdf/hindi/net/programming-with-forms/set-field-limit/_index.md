...
The `FormEditor` क्लास पीडीएफ में फॉर्म फ़ील्ड में बदलाव करने के तरीके प्रदान करता है। इस क्लास का इंस्टेंस बनाकर, आप अपने पीडीएफ फॉर्म में बदलाव करने की तैयारी कर रहे हैं।
...
The `BindPdf` विधि निर्दिष्ट पीडीएफ फ़ाइल को लोड करती है `FormEditor` सुनिश्चित करें कि फ़ाइल `input.pdf` आपके निर्दिष्ट निर्देशिका में मौजूद है.
