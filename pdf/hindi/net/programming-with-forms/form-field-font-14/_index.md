...
सबसे पहले हमें पीडीएफ दस्तावेज़ खोलना होगा जिसमें वह फ़ॉर्म फ़ील्ड है जिसे आप संशोधित करना चाहते हैं। `Document` ऐसा करने के लिए Aspose.PDF लाइब्रेरी से क्लास डाउनलोड करें।
...
अब, आइए एक फ़ॉन्ट ऑब्जेक्ट बनाएं जो हमारे फ़ॉर्म फ़ील्ड के लिए नया फ़ॉन्ट परिभाषित करेगा। Aspose.PDF आपको विभिन्न फ़ॉन्ट तक पहुँच प्रदान करता है `FontRepository` कक्षा।
