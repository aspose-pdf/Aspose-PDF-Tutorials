...
अब, एक्सेल शीट से डेटा को डेटाटेबल ऑब्जेक्ट में निर्यात करें, जो डेटा को पीडीएफ में स्थानांतरित करने के लिए मध्यस्थ के रूप में कार्य करेगा।
...
स्पष्टीकरण: `ImportDataTable` विधि सभी डेटा को स्थानांतरित करती है `DataTable` पीडीएफ टेबल में। यह आपके एक्सेल शीट से डेटा के साथ टेबल को पॉप्युलेट करता है।
...
आप उपयोग कर सकते हैं `pdfDocument.Pages.Add()` जितने पृष्ठ आपको आवश्यक हों, उन्हें जोड़ने के लिए।
