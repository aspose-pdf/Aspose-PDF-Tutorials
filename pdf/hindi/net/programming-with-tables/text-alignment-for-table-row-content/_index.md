---
"description": ".NET के लिए Aspose.PDF का उपयोग करके तालिका पंक्तियों में टेक्स्ट संरेखित करना सीखें। पेशेवर PDF दस्तावेज़ बनाने के लिए कोड उदाहरणों के साथ चरण-दर-चरण मार्गदर्शिका।"
...
```
यहां, हम एक निर्देशिका सेट करते हैं जहां पीडीएफ सहेजा जाएगा और इसका एक उदाहरण बनाया जाएगा `Document` क्लास। यह उदाहरण पीडीएफ बनाने के लिए हमारे कैनवास के रूप में कार्य करता है।
...
```
The `Table` क्लास हमें एक नया टेबल ऑब्जेक्ट बनाने में मदद करता है। इससे हम आसानी से पंक्तियाँ और कॉलम जोड़ सकते हैं।
