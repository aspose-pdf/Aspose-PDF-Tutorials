...
इस चरण में, हम एक बनाते हैं `TextFragment` सामग्री के साथ "Aspose.Pdf एक मजबूत घटक है" और इसका रंग नीला पर सेट करें। `IsInLineParagraph` गुण यह सुनिश्चित करता है कि पाठ इनलाइन है, अर्थात यह अन्य तत्वों (जैसे छवि और अतिरिक्त पाठ) के समान पंक्ति में दिखाई देगा।
...
The `Save` विधि अंतिम पीडीएफ फाइल को निर्दिष्ट स्थान पर लिखती है।

## निष्कर्ष

बधाई हो! आपने .NET के लिए Aspose.PDF का उपयोग करके PDF दस्तावेज़ के हेडर में सफलतापूर्वक एक छवि और पाठ जोड़ दिया है। इस ट्यूटोरियल ने आपको आवश्यक चरणों से परिचित कराया, जिसमें दस्तावेज़ बनाना, पृष्ठ जोड़ना, हेडर सम्मिलित करना और पाठ और छवियों जैसी इनलाइन सामग्री रखना शामिल है। Aspose.PDF आपको अपने PDF को प्रबंधित करने के लिए अविश्वसनीय लचीलापन देता है, चाहे वह हेडर, फ़ुटर या जटिल सामग्री में हेरफेर करना हो। 
