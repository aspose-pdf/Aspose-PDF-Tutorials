...
इससे पहले कि आप अपना PDF कन्वर्ट कर सकें, आपको यह निर्दिष्ट करना होगा कि आपके दस्तावेज़ कहाँ संग्रहीत हैं। यह महत्वपूर्ण है क्योंकि प्रोग्राम को यह जानना होगा कि इनपुट PDF कहाँ ढूँढ़ना है और आउटपुट SVG को कहाँ सहेजना है।
...
सेटिंग करके `CompressOutputToZipArchive` को `false`हम यह सुनिश्चित करते हैं कि आउटपुट SVG फ़ाइल को ज़िप करने के बजाय एक स्टैंडअलोन फ़ाइल के रूप में सहेजा जाए।
...
हां, आप एक निर्देशिका में एकाधिक पीडीएफ फाइलों के माध्यम से लूप कर सकते हैं और उसी विधि का उपयोग करके प्रत्येक को एसवीजी में परिवर्तित कर सकते हैं।
