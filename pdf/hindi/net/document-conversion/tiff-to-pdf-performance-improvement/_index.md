...
- .NET के लिए Aspose.PDF: सुनिश्चित करें कि आपके पास नवीनतम संस्करण है [.NET के लिए Aspose.PDF](https://releases.aspose.com/pdf/net/) स्थापित। यदि आपके पास अभी तक यह नहीं है, तो आप [निःशुल्क परीक्षण डाउनलोड करें](https://releases.aspose.com/).
...
The `Document` ऑब्जेक्ट वह स्थान है जहां प्रत्येक TIFF छवि को परिणामी PDF में एक अलग पृष्ठ के रूप में जोड़ा जाएगा।
...
लूप के अंदर, पहला काम प्रत्येक TIFF फ़ाइल को बाइट ऐरे में लोड करना है। इमेज डेटा को कुशलतापूर्वक संभालने के लिए यह महत्वपूर्ण है।
...
The `MemoryStream` और `Bitmap` ऑब्जेक्ट्स आपको मेमोरी में छवि डेटा को संभालने में सक्षम बनाते हैं, जो भौतिक फ़ाइलों के साथ काम करने की तुलना में अधिक कुशल है।
...
The `Image` ऑब्जेक्ट वह मुख्य घटक है जो आपकी TIFF छवि को PDF पृष्ठ से जोड़ता है।
...
पैराग्राफ संग्रह में छवि जोड़ने से यह पृष्ठ सामग्री का हिस्सा बन जाता है, जो अंतिम पीडीएफ में प्रस्तुत करने के लिए तैयार होता है।
...
सेटिंग के अलावा `IsBlackWhite`, आप छवि रिज़ॉल्यूशन को समायोजित कर सकते हैं या Aspose.PDF के संपीड़न विकल्पों का उपयोग करके पीडीएफ को संपीड़ित कर सकते हैं।
