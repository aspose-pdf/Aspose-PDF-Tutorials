...
आरंभ करने के लिए, आपको अपने C# प्रोजेक्ट में आवश्यक नामस्थानों को आयात करना होगा। यह .NET के लिए Aspose.PDF द्वारा प्रदान की गई कक्षाओं और विधियों तक पहुँचने के लिए महत्वपूर्ण है।
...
इसके बाद, आपको वह पीडीएफ दस्तावेज़ लोड करना होगा जिसमें से आप हाइलाइट किए गए टेक्स्ट को निकालना चाहते हैं। यह काम करने के लिए `Document` Aspose.PDF द्वारा प्रदान की गई क्लास.

```csharp
Document doc = new Document(dataDir + "ExtractHighlightedText.pdf");
```

The `Document` क्लास को पीडीएफ फाइल के पथ के साथ इंस्टेंटिएट किया गया है। यहाँ, `"ExtractHighlightedText.pdf"` यह PDF फ़ाइल का नाम है जिसमें हाइलाइट किया गया टेक्स्ट है। सुनिश्चित करें कि यह फ़ाइल निर्दिष्ट निर्देशिका में मौजूद है।
...
The `Annotations` की संपत्ति `Page` ऑब्जेक्ट पीडीएफ के किसी खास पेज पर सभी एनोटेशन तक पहुंच प्रदान करता है। यहां, हम पहले पेज पर प्रत्येक एनोटेशन के माध्यम से लूपिंग कर रहे हैं।
...
The `TextMarkupAnnotation` क्लास का उपयोग हाइलाइट्स सहित टेक्स्ट मार्कअप एनोटेशन को दर्शाने के लिए किया जाता है। `is` कीवर्ड जाँचता है कि क्या एनोटेशन किस प्रकार का है `TextMarkupAnnotation`, और यदि ऐसा है, तो यह एनोटेशन को कास्ट करता है `TextMarkupAnnotation`.
...
The `GetMarkedTextFragments()` विधि एक संग्रह लौटाती है `TextFragment` ऑब्जेक्ट, जिनमें से प्रत्येक हाइलाइट किए गए टेक्स्ट के एक हिस्से का प्रतिनिधित्व करता है। हम इस संग्रह के माध्यम से लूप करते हैं और प्रत्येक टुकड़े के टेक्स्ट को कंसोल पर प्रिंट करते हैं।
