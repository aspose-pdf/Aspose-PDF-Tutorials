...
```
The `Pages.Add()` विधि का उपयोग एक नया पृष्ठ जोड़ने के लिए किया जाता है `doc` नया पेज ऑब्जेक्ट में संग्रहीत किया जाता है। `page` वेरिएबल, जिसका उपयोग हम बाद में एनोटेशन जोड़ते समय करेंगे।

## चरण 3: डिफ़ॉल्ट स्वरूप निर्धारित करें

कॉलआउट की तरह ही एनोटेशन में भी एक विज़ुअल उपस्थिति होती है जिसे आप कस्टमाइज़ कर सकते हैं। इस चरण में, हम परिभाषित करेंगे कि कॉलआउट के भीतर टेक्स्ट कैसा दिखना चाहिए।
...
```
The `Callout` संपत्ति एक सरणी है `Point` ऑब्जेक्ट, जिनमें से प्रत्येक पृष्ठ पर एक निर्देशांक का प्रतिनिधित्व करता है। ये बिंदु कॉलआउट लाइन के पथ को परिभाषित करते हैं, जिससे इसे क्लासिक स्पीच-बबल उपस्थिति मिलती है।
...
```
The `Annotations.Add()` विधि का उपयोग उस पृष्ठ पर एनोटेशन रखने के लिए किया जाता है जिसे हमने पहले बनाया था। यह चरण प्रभावी रूप से पीडीएफ पृष्ठ पर कॉलआउट को "खींचता" है।
...
```
The `RichText` प्रॉपर्टी को HTML कंटेंट के साथ सेट किया जाता है। यह कॉलआउट के भीतर विस्तृत फ़ॉर्मेटिंग की अनुमति देता है, जैसे फ़ॉन्ट आकार, रंग और शैली निर्दिष्ट करना।
...
```
The `Save()` विधि दस्तावेज़ को "SetCalloutProperty.pdf" फ़ाइल नाम के साथ निर्दिष्ट निर्देशिका में सहेजती है। यह चरण हमारी पीडीएफ निर्माण प्रक्रिया को पूरा करता है।
...
The `RichText` प्रॉपर्टी HTML के एक उपसमूह का समर्थन करती है, जिससे आप स्टाइलयुक्त टेक्स्ट और मूल स्वरूपण शामिल कर सकते हैं।
