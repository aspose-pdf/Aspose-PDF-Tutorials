...
1. .NET के लिए Aspose.PDF: आपको अपने प्रोजेक्ट में .NET के लिए Aspose.PDF लाइब्रेरी इंस्टॉल करनी होगी। अगर आपके पास अभी तक यह नहीं है, तो लाइब्रेरी को यहाँ से लें। [.NET के लिए Aspose.PDF डाउनलोड पृष्ठ](https://releases.aspose.com/pdf/net/).
...
The `Remove` विधि जावास्क्रिप्ट फ़ंक्शन का नाम एक तर्क के रूप में लेती है और इसे दस्तावेज़ से हटा देती है।
