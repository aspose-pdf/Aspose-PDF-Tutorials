...
यहाँ, `dataDir` वह जगह है जहाँ आपका PDF एक बार बनने के बाद संग्रहीत किया जाएगा। आप एक खाली जगह भी बना रहे हैं `pdf` दस्तावेज़ का उपयोग करना `Document` Aspose.PDF से क्लास.
...
अब जब हमारे पास एक पेज है, तो चलिए इसमें कुछ टेक्स्ट जोड़ देते हैं! `TextFragment` हमें दस्तावेज़ के भीतर पाठ सम्मिलित करने और प्रारूपित करने की अनुमति देता है।
...
आप किसी भी इमेज को उसके फ़ाइल पथ को निर्दिष्ट करके रख सकते हैं। सुनिश्चित करें कि आपकी इमेज उस निर्देशिका में है जिसे आपने सेट किया है `dataDir`यहीं पर लेयरिंग का जादू काम आता है - आपकी छवि टेक्स्ट लेयर के शीर्ष पर होगी।
