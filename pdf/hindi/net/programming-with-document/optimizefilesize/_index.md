...
यह लाइन कॉल करती है `OptimizeResources` हमारी विधि `pdfDocument` ऑब्जेक्ट पर, हमने पहले कॉन्फ़िगर की गई सभी सेटिंग्स लागू कर दीं।
