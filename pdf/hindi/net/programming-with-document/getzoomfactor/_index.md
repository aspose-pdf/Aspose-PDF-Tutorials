...
The `GoToAction` ऑब्जेक्ट आपको दस्तावेज़ की ओपन क्रिया तक पहुँचने की अनुमति देता है। यहाँ कोड है:
...
यह कोड जाँचता है कि क्या `action` शून्य नहीं है और यदि `Destination` प्रकार का है `XYZExplicitDestination`यदि दोनों शर्तें पूरी होती हैं, तो यह ज़ूम मान प्रिंट करता है; अन्यथा, यह एक सहायक संदेश प्रदान करता है।
