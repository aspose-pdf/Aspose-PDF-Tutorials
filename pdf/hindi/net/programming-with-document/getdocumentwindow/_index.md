...
क्या आप PDF के साथ काम कर रहे हैं और चाहते हैं कि खोले जाने पर वे कैसे दिखें, इस पर अधिक नियंत्रण हो? चाहे वह मेनू बार को छिपाना हो या पहले पेज पर फिट करने के लिए विंडो का आकार बदलना हो, Aspose.PDF for .NET आपको वे सभी उपकरण देता है जिनकी आपको PDF को व्यूअर में खोले जाने पर उसके व्यवहार को अनुकूलित करने के लिए आवश्यकता होती है। इस ट्यूटोरियल में, हम Aspose.PDF for .NET में दस्तावेज़ विंडो सेटिंग को पुनः प्राप्त करने और उसमें हेरफेर करने का तरीका बताने जा रहे हैं।
...
यहाँ, प्रतिस्थापित करें `"YOUR DOCUMENT DIRECTORY"` उस वास्तविक निर्देशिका के साथ जहाँ आपकी PDF फ़ाइल स्थित है। यह आपकी कार्यशील निर्देशिका है जहाँ से आप PDF दस्तावेज़ लोड करेंगे।
...
अब, आइए जाँचें कि दस्तावेज़ विंडो को खोलते समय उसे बीच में रखना चाहिए या नहीं। इसके लिए डिफ़ॉल्ट मान है `false`.
...
कभी-कभी, आप चाहते हैं कि दस्तावेज़ विंडो खुलने पर पीडीएफ के पहले पृष्ठ पर फिट होने के लिए अपने आप आकार बदल ले। यह जाँचने का तरीका यहाँ बताया गया है कि यह सुविधा सक्षम है या नहीं:
...
आप यह नियंत्रित कर सकते हैं कि पूर्ण-स्क्रीन मोड से बाहर निकलने पर दस्तावेज़ कैसा दिखाई देगा `NonFullScreenPageMode` प्रॉपर्टी। यह सेटिंग यह निर्धारित करने में सहायक है कि उपयोगकर्ता को गैर-पूर्ण स्क्रीन मोड में दस्तावेज़ के साथ कैसे इंटरैक्ट करना चाहिए।
...
### क्या मैं पीडीएफ के प्रारंभिक ज़ूम स्तर को अनुकूलित कर सकता हूं?
