...
- The `TextFragment` वस्तु `t1` "पैराग्राफ 3 सेगमेंट" पाठ के साथ आरंभ किया गया है।
...
- The `ZIndex` संपत्ति 1 पर सेट है, जिसका अर्थ है कि यह सबसे निचली परत पर होगा।
- The `Left` और `Top` गुण पृष्ठ पर बॉक्स की सटीक स्थिति को परिभाषित करते हैं।
...
- The `Left` और `Top` गुण छवि को ठीक उसी स्थान पर रखते हैं जहां हम चाहते हैं।
