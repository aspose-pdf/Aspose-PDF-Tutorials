...
Document doc = new Document(dataDir + "प्रतिस्थापित करेंTextPage.pdf");
```

Replace `"YOUR DOCUMENT DIRECTORY/"` वास्तविक पथ के साथ जहाँ आपकी PDF फ़ाइल संग्रहीत है। यह चरण महत्वपूर्ण है क्योंकि यह Aspose को आपके PDF दस्तावेज़ तक पहुँचने की अनुमति देता है। 

## चरण 4: टेक्स्ट फ़्रैगमेंट अवशोषक सेट अप करें

इसके बाद, हम एक प्रोसेसर सेट अप करेंगे जो हमें पीडीएफ से अप्रयुक्त फ़ॉन्ट को पहचानने और हटाने में मदद करेगा। ऐसा करने के लिए कोड यहाँ दिया गया है:
...
```csharp
// सभी टेक्स्ट फ़्रैगमेंट के माध्यम से पुनरावृति करें
