...
इससे पहले कि हम कोड में प्रवेश करें, सुनिश्चित करें कि आपके पास निम्नलिखित आइटम मौजूद हैं:
...
The `TextAbsorber` क्लास एक शक्तिशाली उपकरण है जो आपके द्वारा निर्दिष्ट सीमाओं के भीतर सभी पाठ को कैप्चर करता है।
...
The `Rectangle` ऑब्जेक्ट आपको उस क्षेत्र के निर्देशांक (बिंदुओं में) को परिभाषित करने की अनुमति देता है जहां से पाठ निकाला जाएगा। `TextSearchOptions.LimitToPageBounds` यह सुनिश्चित करता है कि केवल निर्दिष्ट आयत के भीतर का पाठ ही निकाला जाए.

## चरण 4: इच्छित पृष्ठ पर अवशोषक को स्वीकार करें

क्षेत्र स्थापित करने के बाद, अगला कदम स्वीकार करना है `TextAbsorber` उस विशिष्ट पृष्ठ के लिए जिससे आप टेक्स्ट निकालना चाहते हैं। यहाँ, हम PDF के पहले पृष्ठ पर ध्यान केंद्रित करेंगे।
...
फोन करके `Accept` पृष्ठ पर विधि, हम Aspose.PDF को अवशोषक चलाने और परिभाषित क्षेत्र से पाठ इकट्ठा करने का निर्देश देते हैं।
