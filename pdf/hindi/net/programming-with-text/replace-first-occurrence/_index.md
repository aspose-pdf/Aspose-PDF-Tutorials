...
आरंभ करने से पहले, कुछ आवश्यक चीजें हैं जिन्हें आपको तैयार रखना होगा:
...
कोड में जाने से पहले, आपको अपने दस्तावेज़ों का स्थान निर्दिष्ट करना होगा। यह वह स्थान है जहाँ आपकी मूल PDF और आउटपुट फ़ाइल रहेगी।
...
## चरण 3: टेक्स्ट खोजने के लिए टेक्स्ट अवशोषक बनाएं
...
```
The `TextFragments` संपत्ति पाए गए पाठ अंशों के संग्रह तक पहुंच प्रदान करती है, जिससे आप यह जांच सकते हैं कि कितने मिलान पाए गए।
...
```
The `Count` प्रॉपर्टी जाँचती है कि क्या कोई इंस्टेंस मिला है। यदि ऐसा है, तो हम संग्रह में पहले फ़्रैगमेंट तक पहुँचने के लिए आगे बढ़ते हैं (ध्यान दें कि Aspose के लिए संग्रह में इंडेक्सिंग 1 से शुरू होती है)। फिर, `Text` मूल पाठ को "नए वाक्यांश" से बदलने के लिए संपत्ति को संशोधित किया गया है।
...
The `TextFragmentAbsorber` विशेष वर्णों को संभाल सकते हैं, लेकिन सुनिश्चित करें कि आप सही एन्कोडिंग का उपयोग कर रहे हैं।
