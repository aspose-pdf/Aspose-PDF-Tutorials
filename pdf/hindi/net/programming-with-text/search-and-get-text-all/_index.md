...
# सभी टेक्स्ट खोजें और प्राप्त करें
...
- The `dataDir` चर को उस निर्देशिका की ओर इंगित करना चाहिए जहां आपका `SearchAndGetTextFromAll.pdf` फ़ाइल संग्रहीत है.
...
- इससे पीडीएफ मेमोरी में लोड हो जाएगा और प्रोसेसिंग के लिए तैयार हो जाएगा।

## चरण 3: टेक्स्ट अवशोषक बनाएँ

The `TextFragmentAbsorber` ऑब्जेक्ट का उपयोग पीडीएफ के भीतर विशिष्ट टेक्स्ट खोजने के लिए किया जाता है। इस मामले में, हम "टेक्स्ट" शब्द की तलाश करेंगे।
...
- The `TextFragmentAbsorber` स्ट्रिंग के साथ आरंभ किया गया है `"text"`इसका मतलब यह है कि यह पीडीएफ दस्तावेज़ में "टेक्स्ट" शब्द की किसी भी उपस्थिति की तलाश करेगा।
...
- The `Accept` विधि दस्तावेज़ के पृष्ठों पर लागू होती है। यह निर्दिष्ट पाठ के लिए सभी पृष्ठों की खोज करेगा।
...
- The `TextFragments` की संपत्ति `TextFragmentAbsorber` खोज शब्द से मेल खाने वाले सभी पाठ अंशों का संग्रह लौटाता है.
...
आप निकाले गए पाठ को मानक C# फ़ाइल I/O संचालन का उपयोग करके फ़ाइल में लिख सकते हैं, जैसे `StreamWriter`.
