...
1. .NET के लिए Aspose.PDF इंस्टॉल करें। अगर आपके पास यह नहीं है, तो इसे यहाँ से लें [Aspose.PDF डाउनलोड पृष्ठ](https://releases.aspose.com/pdf/net/).
...
हम इसे छोटे-छोटे चरणों में विभाजित करेंगे, ताकि आप आसानी से इसका अनुसरण कर सकें। प्रत्येक चरण प्रक्रिया के एक महत्वपूर्ण भाग पर ध्यान केंद्रित करेगा, जिसमें आपके PDF को सेट करने से लेकर लाइन स्पेसिंग निर्दिष्ट करना शामिल है।
...
The `Position` विधि निर्देशांक सेट करती है जहाँ पाठ पृष्ठ पर दिखाई देगा (इस मामले में, बाईं ओर से 100 इकाइयाँ और नीचे से 600 इकाइयाँ)। लाइन स्पेसिंग मोड सहित फ़ॉर्मेटिंग विकल्प यहाँ लागू होते हैं।
...
हां, आप अन्य मोड का उपयोग कर सकते हैं जैसे `Propयाtional` or `Fixed` आपकी आवश्यकताओं के आधार पर.
