...
# जावा का उपयोग करके पीडीएफ के शीर्षक में नंबरिंग शैली लागू करें
...
आइए Aspose.PDF for Java का उपयोग करके एक नया PDF दस्तावेज़ बनाना शुरू करें। आरंभ करने के लिए यहां कुछ नमूना कोड दिया गया है:
...
// शीर्षक पाठ सेट करें
TextFragment titleFragment = new TextFragment("नंबरिंग शैली लागू करना");
...
### क्या मैं क्रमांकित शीर्षकों के साथ PDF को DOCX या HTML जैसे अन्य प्रारूपों में निर्यात कर सकता हूँ?
