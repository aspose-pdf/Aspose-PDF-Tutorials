...
1. Aspose.PDF untuk .NET: Pastikan Anda telah memasang pustaka Aspose.PDF di lingkungan .NET Anda. Anda dapat mengunduhnya dari [Di Sini](https://releases.aspose.com/pdf/net/).
...
Ruang nama ini akan memberi Anda akses ke `Document`Bahasa Indonesia: `PngDevice`, Dan `Resolution` kelas yang akan Anda gunakan untuk proses konversi.
...
Di sini, kami menghasilkan nama file seperti `image1_out.png`Bahasa Indonesia: `image2_out.png`, dan seterusnya untuk setiap halaman.
