...
# Optimalkan Ukuran File Dalam File PDF
...
Garis ini memanggil `OptimizeResources` metode pada kami `pdfDocument` objek, menerapkan semua pengaturan yang telah kita konfigurasikan sebelumnya.
