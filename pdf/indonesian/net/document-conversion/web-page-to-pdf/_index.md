...
```csharp
WebRequest request = WebRequest.Create("https://en.wikipedia.org/wiki/Halaman_Utama");
...
Setelah konten HTML dimuat, sekarang kita dapat membuat dokumen PDF darinya:
