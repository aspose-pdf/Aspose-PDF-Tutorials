...
# Penyelarasan Teks Untuk Konten Baris Tabel
...
```
Di sini, kita menetapkan direktori tempat PDF akan disimpan dan membuat contoh `Document` kelas. Contoh ini berfungsi sebagai kanvas untuk membangun PDF.
